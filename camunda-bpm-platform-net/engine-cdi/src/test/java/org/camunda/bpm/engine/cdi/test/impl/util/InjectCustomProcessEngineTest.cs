...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class InjectCustomProcessEngineTest
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Rule public org.camunda.bpm.engine.test.ProcessEngineRule processEngineRule = new org.camunda.bpm.engine.test.ProcessEngineRule("org/camunda/bpm/engine/cdi/test/impl/util/camunda.cfg.xml", true);
...
//ORIGINAL LINE: @Test public void testProcessEngineInject()
	  public virtual void testProcessEngineInject()
	  {
		...
		Assert.assertEquals("myCustomEngine", testClass.processEngine.Name);
	  }
	}
