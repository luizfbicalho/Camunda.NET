...
//	import static org.junit.Assert.assertTrue;
	...
	/// 
	/// </summary>
	public class ProcessVariableLocalTypedTest : CdiProcessEngineTestCase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Deployment(resources = "org/camunda/bpm/engine/cdi/test/api/annotation/CompleteTaskTest.bpmn20.xml") public void testProcessVariableLocalTypeAnnotation()
	  [Deployment(resources : "org/camunda/bpm/engine/cdi/test/api/annotation/CompleteTaskTest.bpmn20.xml")]
	  public virtual void testProcessVariableLocalTypeAnnotation()
	  {
		...
		TypedValue value = getBeanInstance(typeof(DeclarativeProcessController)).InjectedLocalValue;
		assertNotNull(value);
