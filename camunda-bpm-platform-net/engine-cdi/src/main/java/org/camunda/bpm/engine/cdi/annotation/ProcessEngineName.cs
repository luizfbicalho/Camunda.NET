...
//ORIGINAL LINE: @Qualifier @Target({ TYPE, METHOD, PARAMETER, FIELD }) @Retention(RUNTIME) @Documented public class ProcessEngineName extends System.Attribute
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	[AttributeUsage(<missing> | <missing> | <missing> | <missing>, AllowMultiple = false, Inherited = false)]
	public class ProcessEngineName : System.Attribute
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Nonbinding public String value();
		public string value;


		public ProcessEngineName(public String value)
		{
			this.value = value;
		}
	}
