...
namespace org.camunda.bpm.engine.cdi.annotation
{
	...
	/// </pre>
	/// 
	/// Note that the current <seealso cref="Task"/> is also available for injection:
	/// <pre>
...
//ORIGINAL LINE: @Qualifier @Retention(RetentionPolicy.RUNTIME) @Target({ ElementType.FIELD, ElementType.PARAMETER, ElementType.METHOD, ElementType.TYPE }) public class TaskId extends System.Attribute
	...
	public class TaskId : System.Attribute
	{
