...
namespace org.camunda.bpm.engine.cdi.annotation
{
	...
	/// </summary>
	/// <seealso cref= BusinessProcess#startTask(String) </seealso>
	/// <seealso cref= BusinessProcess#completeTask()
	/// 
	/// @author Daniel Meyer </seealso>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @InterceptorBinding @Retention(RetentionPolicy.RUNTIME) @Target({ ElementType.METHOD, ElementType.TYPE }) public class CompleteTask extends System.Attribute
	[AttributeUsage(AttributeTargets.Method | AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
	public class CompleteTask : System.Attribute
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Nonbinding boolean endConversation() default false;
		internal bool endConversation;
