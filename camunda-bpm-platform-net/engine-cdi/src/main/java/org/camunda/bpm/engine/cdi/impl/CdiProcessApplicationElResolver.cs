...
namespace org.camunda.bpm.engine.cdi.impl
{
	...
	using CdiResolver = org.camunda.bpm.engine.cdi.impl.el.CdiResolver;
	using ELResolver = org.camunda.bpm.engine.impl.javax.el.ELResolver;

	/// <summary>
	/// <para>Exposes the CdiResolver in a multiple-applications, shared process engine context.</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
	public class CdiProcessApplicationElResolver : ProcessApplicationElResolver
	{
	  ...
	  public virtual int? Precedence
	  {
		  get
		  {
			return org.camunda.bpm.application.ProcessApplicationElResolver_Fields.CDI_RESOLVER;
		  }
	  }
