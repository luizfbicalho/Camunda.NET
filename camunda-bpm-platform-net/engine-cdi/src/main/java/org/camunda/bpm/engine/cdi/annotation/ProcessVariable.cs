...
namespace org.camunda.bpm.engine.cdi.annotation
{
	...
	/// combination with the <seealso cref="StartProcess"/> annotation: 
	/// <pre>
...
//ORIGINAL LINE: @Qualifier @Retention(RetentionPolicy.RUNTIME) @Documented public class ProcessVariable extends System.Attribute
	public class ProcessVariable : System.Attribute
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Nonbinding public String value() default "";
		...
		public ProcessVariable(public String value = "")
		{
			this.value = value;
		}
	}
