...
//ORIGINAL LINE: @Qualifier @Retention(RetentionPolicy.RUNTIME) @Documented public class ProcessVariableLocal extends System.Attribute
	public class ProcessVariableLocal : System.Attribute
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Nonbinding public String value() default "";
		...
		public ProcessVariableLocal(public String value = "")
		{
			this.value = value;
		}
	}
