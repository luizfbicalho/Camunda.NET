...
//ORIGINAL LINE: @Qualifier @Retention(RetentionPolicy.RUNTIME) @Target({ ElementType.FIELD, ElementType.PARAMETER, ElementType.METHOD, ElementType.TYPE }) public class BusinessKey extends System.Attribute
	...
	public class BusinessKey : System.Attribute
	{
