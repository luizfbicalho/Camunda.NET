...
namespace org.camunda.bpm.engine.cdi
{
	...
	/// <summary>
	/// <seealso cref="ExpressionManager"/> for resolving Cdi-managed beans.
	/// 
	/// This <seealso cref="ExpressionManager"/> implementation performs lazy lookup of the
	...
	/// @author Daniel Meyer
	/// </summary>
	public class CdiExpressionManager : ExpressionManager
	{
