...
namespace org.camunda.bpm.engine.impl
{
	...
	public static class HistoricIncidentQueryProperty_Fields
	{
	  ...
	  public static readonly QueryProperty INCIDENT_CREATE_TIME = new QueryPropertyImpl("CREATE_TIME_");
	  public static readonly QueryProperty INCIDENT_END_TIME = new QueryPropertyImpl("END_TIME_");
	  ...
	  public static readonly QueryProperty INCIDENT_STATE = new QueryPropertyImpl("INCIDENT_STATE_");
	}
