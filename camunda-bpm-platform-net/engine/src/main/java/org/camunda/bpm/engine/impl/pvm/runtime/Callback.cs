...
namespace org.camunda.bpm.engine.impl.pvm.runtime
{
	...
	/// <seealso cref="java.util.concurrent.Callable"/> interface, with the exception that the callback method does not throw any
	/// catching exception. Without this restriction the caller does not have to catch any exception.
	/// </summary>
	/// @param <P> the type of the callback parameter </param>
	/// @param <R> the type of the callback result
	/// @author Christopher Zell <christopher.zell@camunda.com> </param>
	public interface Callback<P, R>
	{
	  ...
	  /// </summary>
	  /// <param name="param"> the parameter for the callback </param>
