...
namespace org.camunda.bpm.engine.impl
{
	...
	public class NativeProcessInstanceQueryImpl : AbstractNativeQuery<NativeProcessInstanceQuery, ProcessInstance>, NativeProcessInstanceQuery
	{
	 ...
	 //results ////////////////////////////////////////////////////////////////
	  ...
	  public override IList<ProcessInstance> executeList(CommandContext commandContext, IDictionary<string, object> parameterMap, int firstResult, int maxResults)
	  {
		return commandContext.ExecutionManager.findProcessInstanceByNativeQuery(parameterMap, firstResult, maxResults);
	  }

	  public override long executeCount(CommandContext commandContext, IDictionary<string, object> parameterMap)
	  {
		return commandContext.ExecutionManager.findExecutionCountByNativeQuery(parameterMap);
	  }
