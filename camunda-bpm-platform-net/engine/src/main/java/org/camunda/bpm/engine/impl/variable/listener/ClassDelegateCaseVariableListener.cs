...
//	import static org.camunda.bpm.engine.impl.util.ClassDelegateUtil.instantiateDelegate;
	...
	/// 
	/// </summary>
	public class ClassDelegateCaseVariableListener : ClassDelegate, CaseVariableListener
	{

	  public ClassDelegateCaseVariableListener(string className, IList<FieldDeclaration> fieldDeclarations) : base(className, fieldDeclarations)
	  {
	  }

	  public ClassDelegateCaseVariableListener(Type clazz, IList<FieldDeclaration> fieldDeclarations) : base(clazz, fieldDeclarations)
	  {
	  }
...
//ORIGINAL LINE: public void notify(org.camunda.bpm.engine.delegate.DelegateCaseVariableInstance variableInstance) throws Exception
	  ...
	  protected internal virtual CaseVariableListener VariableListenerInstance
	  {
		  get
		  {
			object delegateInstance = instantiateDelegate(className, fieldDeclarations);
			if (delegateInstance is CaseVariableListener)
			{
	...
	//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
			  throw new ProcessEngineException(delegateInstance.GetType().FullName + " doesn't implement " + typeof(CaseVariableListener));
			}
		  }
	  }
