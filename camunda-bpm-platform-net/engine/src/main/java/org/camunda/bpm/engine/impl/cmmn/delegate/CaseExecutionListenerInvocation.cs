 ...
 */
namespace org.camunda.bpm.engine.impl.cmmn.@delegate
{
	...
	/// </summary>
	public class CaseExecutionListenerInvocation : DelegateInvocation
	{

	  protected internal readonly CaseExecutionListener listenerInstance;
	  protected internal readonly DelegateCaseExecution caseExecution;
