...
namespace org.camunda.bpm.engine.impl.calendar
{
	...
	/// </summary>
	/// <seealso cref= CAM-1170 </seealso>
	public class DateTimeUtil
	{

	  private static readonly DateTimeZone JVM_DEFAULT_DATE_TIME_ZONE = DateTimeZone.forTimeZone(TimeZone.Default);

	  private static DateTimeFormatter DATE_TIME_FORMATER;

	  private static DateTimeFormatter DataTimeFormater
	  {
		  get
		  {
	  ...
	  {
		return DataTimeFormater.parseDateTime(date);
	  }
