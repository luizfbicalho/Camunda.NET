...
//	import static org.camunda.bpm.engine.@delegate.CaseExecutionListener_Fields.PARENT_RESUME;
	...
	/// 
	/// </summary>
	public class AtomicOperationCaseExecutionParentResume : AbstractAtomicOperationCaseExecutionResume
	{
