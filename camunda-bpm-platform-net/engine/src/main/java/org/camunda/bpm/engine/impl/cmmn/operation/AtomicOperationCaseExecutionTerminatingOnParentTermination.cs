...
//	import static org.camunda.bpm.engine.impl.cmmn.execution.CaseExecutionState_Fields.TERMINATING_ON_PARENT_TERMINATION;
	...
	/// 
	/// </summary>
	public class AtomicOperationCaseExecutionTerminatingOnParentTermination : AbstractAtomicOperationCaseExecutionTerminating
	{
	  ...
	  protected internal override CaseExecutionState TerminatingState
	  {
		  get
		  {
