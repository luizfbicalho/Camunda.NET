...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureNotNull;
	...
	[Serializable]
	public class CreateTenantUserMembershipCmd : AbstractWritableIdentityServiceCmd<Void>, Command<Void>
	{
	  ...
	  protected internal override Void executeCmd(CommandContext commandContext)
	  {
		...
		IdentityOperationResult operationResult = commandContext.WritableIdentityProvider.createTenantUserMembership(tenantId, userId);
