...
//	import static org.camunda.bpm.engine.impl.util.ActivityBehaviorUtil.getActivityBehavior;
	...
	/// 
	/// </summary>
	public abstract class AbstractAtomicOperationCaseExecutionTerminating : CmmnAtomicOperation
	{

	  public virtual void execute(CmmnExecution execution)
	  {
		execution.CurrentState = TerminatingState;
	  ...
	  protected internal abstract CaseExecutionState TerminatingState {get;}
