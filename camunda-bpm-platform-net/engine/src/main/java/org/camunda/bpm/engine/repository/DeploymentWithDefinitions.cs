...
namespace org.camunda.bpm.engine.repository
{
	...
	/// </summary>
	public interface DeploymentWithDefinitions : Deployment
	{
	  ...
	  IList<ProcessDefinition> DeployedProcessDefinitions {get;}
	  ...
	  IList<CaseDefinition> DeployedCaseDefinitions {get;}
	  ...
	  IList<DecisionDefinition> DeployedDecisionDefinitions {get;}

	  /// <summary>
	  /// Returns the decision requirements definitions, which are deployed with that deployment
	  /// </summary>
	  /// <returns> the decision definitions, which are deployed </returns>
	  IList<DecisionRequirementsDefinition> DeployedDecisionRequirementsDefinitions {get;}
	}
