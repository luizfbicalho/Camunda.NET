...
//	import static org.camunda.bpm.engine.impl.cmmn.execution.CaseExecutionState_Fields.SUSPENDING_ON_PARENT_SUSPENSION;
	...
	/// 
	/// </summary>
	public class AtomicOperationCaseExecutionSuspendingOnParentSuspension : AbstractAtomicOperationCaseExecutionSuspending
	{
	  ...
	  protected internal override CaseExecutionState SuspendingState
	  {
		  get
		  {
