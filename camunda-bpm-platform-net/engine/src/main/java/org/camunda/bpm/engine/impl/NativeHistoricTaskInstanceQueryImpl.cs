...
namespace org.camunda.bpm.engine.impl
{
	...
	public class NativeHistoricTaskInstanceQueryImpl : AbstractNativeQuery<NativeHistoricTaskInstanceQuery, HistoricTaskInstance>, NativeHistoricTaskInstanceQuery
	{
	 ...
	 //results ////////////////////////////////////////////////////////////////
	  ...
	  public override IList<HistoricTaskInstance> executeList(CommandContext commandContext, IDictionary<string, object> parameterMap, int firstResult, int maxResults)
	  {
		return commandContext.HistoricTaskInstanceManager.findHistoricTaskInstancesByNativeQuery(parameterMap, firstResult, maxResults);
	  }

	  public override long executeCount(CommandContext commandContext, IDictionary<string, object> parameterMap)
	  {
		return commandContext.HistoricTaskInstanceManager.findHistoricTaskInstanceCountByNativeQuery(parameterMap);
	  }
