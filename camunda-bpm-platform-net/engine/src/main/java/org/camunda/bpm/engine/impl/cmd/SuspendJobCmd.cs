...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	public class SuspendJobCmd : AbstractSetJobStateCmd
	{
	  ...
	  public SuspendJobCmd(UpdateJobSuspensionStateBuilderImpl builder) : base(builder)
	  {
	  }
	  ...
	  protected internal override string LogEntryOperation
	  {
		  get
		  {
			return org.camunda.bpm.engine.history.UserOperationLogEntry_Fields.OPERATION_TYPE_SUSPEND_JOB;
		  }
	  }
	}
