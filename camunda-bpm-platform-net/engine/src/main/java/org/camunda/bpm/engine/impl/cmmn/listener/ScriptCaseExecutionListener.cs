...
namespace org.camunda.bpm.engine.impl.cmmn.listener
{
	...
	/// <summary>
	/// An <seealso cref="CaseExecutionListener"/> which invokes a <seealso cref="ExecutableScript"/> when notified.
	/// 
	/// @author Roman Smirnov
	/// @author Sebastian Menski
	/// </summary>
	public class ScriptCaseExecutionListener : CaseExecutionListener
	{
