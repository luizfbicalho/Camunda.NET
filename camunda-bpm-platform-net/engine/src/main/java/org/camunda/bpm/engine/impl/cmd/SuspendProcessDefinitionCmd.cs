...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	public class SuspendProcessDefinitionCmd : AbstractSetProcessDefinitionStateCmd
	{
	  ...
	  protected internal override SuspendProcessInstanceCmd getNextCommand(UpdateProcessInstanceSuspensionStateBuilderImpl processInstanceCommandBuilder)
	  {
	  ...
	  protected internal override string LogEntryOperation
	  {
		  get
		  {
			return org.camunda.bpm.engine.history.UserOperationLogEntry_Fields.OPERATION_TYPE_SUSPEND_PROCESS_DEFINITION;
		  }
	  }
