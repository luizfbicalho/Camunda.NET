...
namespace org.camunda.bpm.engine.impl.persistence.entity
{
	...
	/// 
	/// </summary>
	public class VariableInstanceEntityPersistenceListener : VariableInstanceLifecycleListener<VariableInstanceEntity>
	{

	  public static readonly VariableInstanceEntityPersistenceListener INSTANCE = new VariableInstanceEntityPersistenceListener();
