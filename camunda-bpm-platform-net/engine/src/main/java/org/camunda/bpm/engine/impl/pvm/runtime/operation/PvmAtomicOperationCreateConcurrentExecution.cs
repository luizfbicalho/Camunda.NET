...
namespace org.camunda.bpm.engine.impl.pvm.runtime.operation
{
	...
	/// <summary>
	/// <para>Base atomic operation used for implementing atomic operations which
	/// create a new concurrent execution for executing an activity. This atomic
	/// operation makes sure the execution is created under the correct parent.</para>
	/// 
	...
	/// 
	/// </summary>
	public abstract class PvmAtomicOperationCreateConcurrentExecution : PvmAtomicOperation
	{
