...
namespace org.camunda.bpm.engine.exception.dmn
{
	...
	public class DecisionException : ProcessEngineException
	{
	  ...
	  public DecisionException() : base()
	  {
	  }

	  public DecisionException(string message, Exception cause) : base(message, cause)
	  {
	  }
	  ...
	  public DecisionException(Exception cause) : base(cause)
	  {
	  }
