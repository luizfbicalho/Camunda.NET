...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	public class AddUserIdentityLinkCmd : AddIdentityLinkCmd
	{
	  ...
	  public override Void execute(CommandContext commandContext)
	  {
		...
		commandContext.OperationLogManager.logLinkOperation(org.camunda.bpm.engine.history.UserOperationLogEntry_Fields.OPERATION_TYPE_ADD_USER_LINK, task, propertyChange);
