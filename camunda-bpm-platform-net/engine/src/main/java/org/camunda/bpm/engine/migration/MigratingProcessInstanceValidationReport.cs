...
namespace org.camunda.bpm.engine.migration
{
	...
	public interface MigratingProcessInstanceValidationReport
	{
	  ...
	  IList<MigratingActivityInstanceValidationReport> ActivityInstanceReports {get;}

	  /// <returns> the list of transition instance validation reports </returns>
	  IList<MigratingTransitionInstanceValidationReport> TransitionInstanceReports {get;}
