...
namespace org.camunda.bpm.engine.impl.json
{
	...
	public class MigrationInstructionJsonConverter : JsonObjectConverter<MigrationInstruction>
	{

	  public static readonly MigrationInstructionJsonConverter INSTANCE = new MigrationInstructionJsonConverter();

	  public const string SOURCE_ACTIVITY_IDS = "sourceActivityIds";
	  public const string TARGET_ACTIVITY_IDS = "targetActivityIds";
	  public const string UPDATE_EVENT_TRIGGER = "updateEventTrigger";
