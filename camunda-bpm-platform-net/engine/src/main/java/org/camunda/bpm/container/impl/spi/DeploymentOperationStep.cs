...
{
	/// <summary>
	/// <para>An atomic step that is part of a composite <seealso cref="DeploymentOperation"/>.</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
	public abstract class DeploymentOperationStep
	{
	  ...
	  public virtual void cancelOperationStep(DeploymentOperation operationContext)
	  {
