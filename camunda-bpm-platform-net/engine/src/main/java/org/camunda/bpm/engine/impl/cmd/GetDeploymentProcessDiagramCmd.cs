...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	/// </summary>
	[Serializable]
	public class GetDeploymentProcessDiagramCmd : Command<Stream>
	{
...
//ORIGINAL LINE: final String resourceName = processDefinition.getDiagramResourceName();
	  ...
	  {
		  private readonly GetDeploymentProcessDiagramCmd outerInstance;

		  private CommandContext commandContext;
		  private string deploymentId;
		  private string resourceName;

		  public CallableAnonymousInnerClass(GetDeploymentProcessDiagramCmd outerInstance, CommandContext commandContext, string deploymentId, string resourceName)
		  {
