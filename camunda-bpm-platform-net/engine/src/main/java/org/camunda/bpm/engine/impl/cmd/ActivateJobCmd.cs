...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	public class ActivateJobCmd : AbstractSetJobStateCmd
	{
	  ...
	  public ActivateJobCmd(UpdateJobSuspensionStateBuilderImpl builder) : base(builder)
	  {
	  }
	  ...
	  protected internal override string LogEntryOperation
	  {
		  get
		  {
			return org.camunda.bpm.engine.history.UserOperationLogEntry_Fields.OPERATION_TYPE_ACTIVATE_JOB;
		  }
	  }
	}
