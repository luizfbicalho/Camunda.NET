...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureWhitelistedResourceId;
	...
	[Serializable]
	public class CreateTenantCmd : AbstractWritableIdentityServiceCmd<Tenant>, Command<Tenant>
	{
	  ...
	  protected internal override Tenant executeCmd(CommandContext commandContext)
	  {
