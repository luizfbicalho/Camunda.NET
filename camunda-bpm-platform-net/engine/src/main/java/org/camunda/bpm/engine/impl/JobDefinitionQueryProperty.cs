...
namespace org.camunda.bpm.engine.impl
{
	...
	/// <summary>
	/// Contains the possible properties that can be used in a <seealso cref="JobDefinitionQuery"/>.
	/// 
	...
	public static class JobDefinitionQueryProperty_Fields
	{
	  public static readonly QueryProperty JOB_DEFINITION_ID = new QueryPropertyImpl("ID_");
	  ...
	  public static readonly QueryProperty JOB_TYPE = new QueryPropertyImpl("JOB_TYPE_");
	  public static readonly QueryProperty JOB_CONFIGURATION = new QueryPropertyImpl("JOB_CONFIGURATION_");
