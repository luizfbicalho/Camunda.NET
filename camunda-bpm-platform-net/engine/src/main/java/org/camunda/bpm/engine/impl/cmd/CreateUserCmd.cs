...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureWhitelistedResourceId;
	...
	/// </summary>
	[Serializable]
	public class CreateUserCmd : AbstractWritableIdentityServiceCmd<User>, Command<User>
	{
	  ...
	  protected internal override User executeCmd(CommandContext commandContext)
	  {
