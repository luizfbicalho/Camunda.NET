...
namespace org.camunda.bpm.engine.impl.core.model
{
	...
	/// </summary>
	/// <param name="T"> the type of elements in the list
	/// 
...
//ORIGINAL LINE: PropertyListKey<?> other = (PropertyListKey<?>) obj;
		PropertyListKey<object> other = (PropertyListKey<object>) obj;
