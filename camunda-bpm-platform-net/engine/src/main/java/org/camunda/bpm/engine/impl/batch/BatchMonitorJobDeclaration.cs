...
namespace org.camunda.bpm.engine.impl.batch
{
	...
	/// </summary>
	[Serializable]
	public class BatchMonitorJobDeclaration : JobDeclaration<BatchEntity, MessageEntity>
	{
	  ...
	  {
		return new BatchMonitorJobConfiguration(batch.Id);
	  }

	  protected internal override string resolveJobDefinitionId(BatchEntity batch)
	  {
		return batch.MonitorJobDefinitionId;
	  }
