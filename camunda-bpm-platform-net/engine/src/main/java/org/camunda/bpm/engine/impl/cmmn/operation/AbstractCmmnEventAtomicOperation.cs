...
//	import static org.camunda.bpm.engine.impl.util.ActivityBehaviorUtil.getActivityBehavior;
	...
	/// 
	/// </summary>
	public abstract class AbstractCmmnEventAtomicOperation : AbstractEventAtomicOperation<CmmnExecution>, CmmnAtomicOperation
	{
		public abstract void execute(CmmnExecution execution);

	  protected internal virtual CmmnActivity getScope(CmmnExecution execution)
	  {
	  ...
	  protected internal virtual void eventNotificationsCompleted(CmmnExecution execution)
	  {
	  ...
	  protected internal virtual void repetition(CmmnExecution execution)
	  {
		CmmnActivityBehavior behavior = getActivityBehavior(execution);
		behavior.repeat(execution, EventName);
	  }

	  protected internal virtual void preTransitionNotification(CmmnExecution execution)
	  {

	  }

	  protected internal virtual void performTransitionNotification(CmmnExecution execution)
	  {
	  ...
	  protected internal virtual void postTransitionNotification(CmmnExecution execution)
	  {
		// noop
	  }
