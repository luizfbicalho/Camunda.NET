...
//	import static org.camunda.bpm.engine.@delegate.CaseExecutionListener_Fields.RESUME;
	...
	/// 
	/// </summary>
	public class AtomicOperationCaseExecutionResume : AbstractAtomicOperationCaseExecutionResume
	{
