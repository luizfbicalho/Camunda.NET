...
namespace org.camunda.bpm.engine.impl.cmmn.handler
{
	...
	using EventListenerActivityBehavior = org.camunda.bpm.engine.impl.cmmn.behavior.EventListenerActivityBehavior;
	...
	/// 
	/// </summary>
	public class EventListenerItemHandler : ItemHandler
	{
	  ...
	  protected internal override void initializeRepetitionRule(CmmnElement element, CmmnActivity activity, CmmnHandlerContext context)
	  {
