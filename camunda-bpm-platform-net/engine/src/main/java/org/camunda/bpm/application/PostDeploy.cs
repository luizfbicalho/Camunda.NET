...
namespace org.camunda.bpm.application
{
	...
	/// 
	/// <para>The method will be invoked after the process application has been successfully deployed, meaning that 
	/// <ul>
	///  <li>If the process application defines one or more <seealso cref="ProcessEngine ProcessEngines"/>, all process 
	...
	/// Method.</para>
	/// 
	/// <para><strong>NOTE:</strong> if the {@literal @}PostDeploy method throws an exception, the deployment of the process application will 
	/// be rolled back, all process engine deployments will be removed and all process engines defined by this 
	/// application will be stopped.</para>
	/// 
	...
	/// </pre>
	/// 
	/// <para>A method annotated with <code>{@literal @}PostDeploy</code> may additionally take the following set of 
	...
	public class PostDeploy : System.Attribute
	{
