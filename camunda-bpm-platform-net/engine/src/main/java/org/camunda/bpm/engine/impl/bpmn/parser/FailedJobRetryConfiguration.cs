...
namespace org.camunda.bpm.engine.impl.bpmn.parser
{
	...
	public class FailedJobRetryConfiguration
	{
	  ...
	  protected internal IList<string> retryIntervals;
	  ...
	  public FailedJobRetryConfiguration(int retries, IList<string> retryIntervals)
	  {
	  ...
	  public virtual IList<string> RetryIntervals
	  {
		  get
		  {
