...
namespace org.camunda.bpm.container.impl.deployment
{
	...
	/// <summary>
	/// <para>Operation step responsible for invoking the {@literal @}<seealso cref="PreUndeploy"/> method of a
	/// ProcessApplication class.</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
	public class PreUndeployInvocationStep : DeploymentOperationStep
	{

	  private const string CALLBACK_NAME = "@PreUndeploy";
