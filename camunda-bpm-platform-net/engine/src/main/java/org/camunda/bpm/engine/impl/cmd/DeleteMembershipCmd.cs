...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureNotNull;
	...
	/// </summary>
	[Serializable]
	public class DeleteMembershipCmd : AbstractWritableIdentityServiceCmd<Void>, Command<Void>
	{
	  ...
	  protected internal override Void executeCmd(CommandContext commandContext)
	  {
		...
		IdentityOperationResult operationResult = commandContext.WritableIdentityProvider.deleteMembership(userId, groupId);
