...
namespace org.camunda.bpm.container.impl.metadata
{
	...
	/// <summary>
	/// <para>Implementation of the <seealso cref="JobAcquisitionXml"/> SPI interface</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
	public class JobAcquisitionXmlImpl : JobAcquisitionXml
	{
	  ...
	  public virtual string JobExecutorClassName
	  {
		  get
		  {
		  ...
		  set
		  {
			this.jobExecutorClassName = value;
		  }
	  }
