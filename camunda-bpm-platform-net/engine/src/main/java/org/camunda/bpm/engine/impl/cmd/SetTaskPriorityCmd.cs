...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureNotNull;
	...
	/// </summary>
	[Serializable]
	public class SetTaskPriorityCmd : Command<Void>
	{
	  ...
	  public virtual Void execute(CommandContext commandContext)
	  {
		...
		task.createHistoricTaskDetails(org.camunda.bpm.engine.history.UserOperationLogEntry_Fields.OPERATION_TYPE_SET_PRIORITY);
