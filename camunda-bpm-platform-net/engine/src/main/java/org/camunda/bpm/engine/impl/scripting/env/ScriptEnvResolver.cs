...
namespace org.camunda.bpm.engine.impl.scripting.env
{
	...
	public interface ScriptEnvResolver
	{
	  ...
	  /// </summary>
	  /// <param name="the"> script language to resolve env scripts for. </param>
	  /// <returns> an array of environment script sources or null if this
	  /// resolver does not provide any scripts for the given language </returns>
