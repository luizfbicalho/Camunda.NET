...
namespace org.camunda.bpm.engine.impl.dmn.transformer
{
	...
	using DmnDecisionRequirementsGraphTransformHandler = org.camunda.bpm.dmn.engine.impl.transform.DmnDecisionRequirementsGraphTransformHandler;
	...
	public class DecisionRequirementsDefinitionTransformHandler : DmnDecisionRequirementsGraphTransformHandler
	{
	  ...
	  protected internal override DmnDecisionRequirementsGraphImpl createFromDefinitions(DmnElementTransformContext context, Definitions definitions)
	  {
		DecisionRequirementsDefinitionEntity entity = (DecisionRequirementsDefinitionEntity) base.createFromDefinitions(context, definitions);
