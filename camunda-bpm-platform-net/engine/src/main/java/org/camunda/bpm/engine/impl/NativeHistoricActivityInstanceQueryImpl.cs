...
namespace org.camunda.bpm.engine.impl
{
	...
	public class NativeHistoricActivityInstanceQueryImpl : AbstractNativeQuery<NativeHistoricActivityInstanceQuery, HistoricActivityInstance>, NativeHistoricActivityInstanceQuery
	{
	 ...
	 //results ////////////////////////////////////////////////////////////////
	  ...
	  public override IList<HistoricActivityInstance> executeList(CommandContext commandContext, IDictionary<string, object> parameterMap, int firstResult, int maxResults)
	  {
		return commandContext.HistoricActivityInstanceManager.findHistoricActivityInstancesByNativeQuery(parameterMap, firstResult, maxResults);
	  }

	  public override long executeCount(CommandContext commandContext, IDictionary<string, object> parameterMap)
	  {
		return commandContext.HistoricActivityInstanceManager.findHistoricActivityInstanceCountByNativeQuery(parameterMap);
	  }
