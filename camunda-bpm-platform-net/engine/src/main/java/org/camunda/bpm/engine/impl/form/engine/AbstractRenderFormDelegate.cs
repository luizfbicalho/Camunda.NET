...
namespace org.camunda.bpm.engine.impl.form.engine
{
	...
	public abstract class AbstractRenderFormDelegate
	{
	  ...
	  /* date format */
	  protected internal const string DATE_FORMAT = "dd/MM/yyyy";
	  ...
	  protected internal static readonly string INVALID_DATE_FIELD_MESSAGE = "Invalid date format: the date should have the pattern '" + DATE_FORMAT + "'";
