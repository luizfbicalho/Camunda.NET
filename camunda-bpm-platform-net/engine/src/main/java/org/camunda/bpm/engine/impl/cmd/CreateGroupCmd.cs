...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureWhitelistedResourceId;
	...
	/// </summary>
	[Serializable]
	public class CreateGroupCmd : AbstractWritableIdentityServiceCmd<Group>, Command<Group>
	{
	  ...
	  protected internal override Group executeCmd(CommandContext commandContext)
	  {
