...
namespace org.camunda.bpm.engine.impl
{
	...
	public static class HistoricProcessInstanceQueryProperty_Fields
	{
	  public static readonly QueryProperty PROCESS_INSTANCE_ID_ = new QueryPropertyImpl("PROC_INST_ID_");
	  ...
	  public static readonly QueryProperty PROCESS_DEFINITION_NAME = new QueryPropertyImpl("NAME_");
	  public static readonly QueryProperty PROCESS_DEFINITION_VERSION = new QueryPropertyImpl("VERSION_");
	  public static readonly QueryProperty BUSINESS_KEY = new QueryPropertyImpl("BUSINESS_KEY_");
	  public static readonly QueryProperty START_TIME = new QueryPropertyImpl("START_TIME_");
	  public static readonly QueryProperty END_TIME = new QueryPropertyImpl("END_TIME_");
