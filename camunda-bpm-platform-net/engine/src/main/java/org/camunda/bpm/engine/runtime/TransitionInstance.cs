...
{
	/// <summary>
	/// <para>A transition instance represents an execution token that
	...
	/// which is why the corresponding activity instance does not exist.</para>
	/// 
	/// <para>Transition instances are the result of
	/// asynchronous continuations, asyncBefore or asyncAfter.</para>
	/// 
	/// @author Daniel Meyer
	/// @author Thorben Lindhauer
	/// 
	/// </summary>
	public interface TransitionInstance : ProcessElementInstance
	{
