...
namespace org.camunda.bpm.engine.migration
{
	...
	/// Migration instructions are always contained in a <seealso cref="MigrationPlan"/>.
	/// 
	...
	public interface MigrationInstruction
	{
	  ...
	  /// <returns> the id of the activity of the source process definition that this
	  /// instruction maps instances from </returns>
	  string SourceActivityId {get;}

	  /// <returns> the id of the activity of the target process definition that this
	  /// instruction maps instances to </returns>
