...
namespace org.camunda.bpm.engine.impl.@delegate
{
	...
	public class ExpressionSetInvocation : DelegateInvocation
	{
	  ...
	  public ExpressionSetInvocation(ValueExpression valueExpression, ELContext elContext, object value, BaseDelegateExecution contextExecution) : base(contextExecution, null)
	  {
