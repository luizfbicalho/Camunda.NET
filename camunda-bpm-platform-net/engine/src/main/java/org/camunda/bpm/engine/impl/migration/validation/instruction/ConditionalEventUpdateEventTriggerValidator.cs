...
namespace org.camunda.bpm.engine.impl.migration.validation.instruction
{
	...
	/// </summary>
	public class ConditionalEventUpdateEventTriggerValidator : MigrationInstructionValidator
	{

	  public const string MIGRATION_CONDITIONAL_VALIDATION_ERROR_MSG = "Conditional event has to migrate with update event trigger.";
