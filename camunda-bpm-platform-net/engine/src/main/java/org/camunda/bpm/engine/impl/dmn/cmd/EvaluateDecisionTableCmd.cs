...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureOnlyOneNotNull;
	...
	/// </summary>
	public class EvaluateDecisionTableCmd : Command<DmnDecisionTableResult>
	{
	  ...
	  public virtual DmnDecisionTableResult execute(CommandContext commandContext)
	  {
	  ...
	  protected internal virtual DmnDecisionTableResult doEvaluateDecision(DecisionDefinition decisionDefinition, VariableMap variables)
	  {
		try
		{
