...
namespace org.camunda.bpm.engine.impl
{
	...
	/// <summary>
	/// Contains the possible properties that can be used in a <seealso cref="TaskQuery"/>.
	/// 
	/// @author Joram Barrez
	/// </summary>
	...
	public static class TaskQueryProperty_Fields
	{
	  public static readonly QueryProperty TASK_ID = new QueryPropertyImpl("ID_");
	  public static readonly QueryProperty NAME = new QueryPropertyImpl("NAME_");
	  public static readonly QueryProperty NAME_CASE_INSENSITIVE = new QueryPropertyImpl("NAME_", "LOWER");
	  public static readonly QueryProperty DESCRIPTION = new QueryPropertyImpl("DESCRIPTION_");
	  public static readonly QueryProperty PRIORITY = new QueryPropertyImpl("PRIORITY_");
	  public static readonly QueryProperty ASSIGNEE = new QueryPropertyImpl("ASSIGNEE_");
	  ...
	  public static readonly QueryProperty DUE_DATE = new QueryPropertyImpl("DUE_DATE_");
	  public static readonly QueryProperty FOLLOW_UP_DATE = new QueryPropertyImpl("FOLLOW_UP_DATE_");
