...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	public class SuspendProcessInstanceCmd : AbstractSetProcessInstanceStateCmd
	{
	  ...
	  public SuspendProcessInstanceCmd(UpdateProcessInstanceSuspensionStateBuilderImpl builder) : base(builder)
	  {
	  }
	  ...
	  protected internal override string LogEntryOperation
	  {
		  get
		  {
			return org.camunda.bpm.engine.history.UserOperationLogEntry_Fields.OPERATION_TYPE_SUSPEND;
		  }
	  }
