...
namespace org.camunda.bpm.engine.impl.javax.el
{
	...
	/// comparison, serialization and immutability in the <seealso cref="Expression"/> javadocs.
	/// </summary>
	/// <seealso cref= ELResolver </seealso>
	/// <seealso cref= Expression </seealso>
	/// <seealso cref= ExpressionFactory </seealso>
	[Serializable]
	public abstract class MethodExpression : Expression
	{
		...
		/// </para>
		/// </summary>
		/// <returns> <code>true</code> if the MethodExpression was created with parameters,
		///         <code>false</code> otherwise.
		/// @since 2.2 </returns>
		public virtual bool ParmetersProvided
		{
			get
			{
				return false;
