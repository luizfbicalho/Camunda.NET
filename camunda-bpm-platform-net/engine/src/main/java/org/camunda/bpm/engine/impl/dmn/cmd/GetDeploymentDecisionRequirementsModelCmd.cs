...
namespace org.camunda.bpm.engine.impl.dmn.cmd
{
	...
	/// </summary>
	[Serializable]
	public class GetDeploymentDecisionRequirementsModelCmd : Command<Stream>
	{
...
//ORIGINAL LINE: final String resourceName = decisionRequirementsDefinition.getResourceName();
	  ...
	  {
		  private readonly GetDeploymentDecisionRequirementsModelCmd outerInstance;

		  private CommandContext commandContext;
		  private string deploymentId;
		  private string resourceName;

		  public CallableAnonymousInnerClass(GetDeploymentDecisionRequirementsModelCmd outerInstance, CommandContext commandContext, string deploymentId, string resourceName)
		  {
