...
//	import static org.camunda.bpm.engine.impl.util.EnsureUtil.ensureNotNull;
	...
	[Serializable]
	public class CreateTenantGroupMembershipCmd : AbstractWritableIdentityServiceCmd<Void>, Command<Void>
	{
	  ...
	  protected internal override Void executeCmd(CommandContext commandContext)
	  {
		...
		IdentityOperationResult operationResult = commandContext.WritableIdentityProvider.createTenantGroupMembership(tenantId, groupId);
