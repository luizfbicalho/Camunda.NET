...
namespace org.camunda.bpm.engine.impl.form.validator
{
	...
	public class FormFieldConfigurationException : FormException
	{
	  ...
	  public FormFieldConfigurationException(string configuration) : base()
	  {

		this.configuration = configuration;
	  }

	  public FormFieldConfigurationException(string configuration, string message, Exception cause) : base(message, cause)
	  {
	  ...
	  public FormFieldConfigurationException(string configuration, Exception cause) : base(cause)
	  {
