...
namespace org.camunda.bpm.engine.impl.cmd
{
	...
	/// </summary>
	[Serializable]
	public class ExecuteFilterListCmd : AbstractExecuteFilterCmd, Command<IList<JavaToDotNetGenericWildcard>>
	{
	  ...
	  public ExecuteFilterListCmd<T1>(string filterId, Query<T1> extendingQuery) : base(filterId, extendingQuery)
	  {
	  }
