...
namespace org.camunda.bpm.engine.impl.dmn.cmd
{
	...
	/// </summary>
	[Serializable]
	public class GetDeploymentDecisionModelCmd : Command<Stream>
	{
...
//ORIGINAL LINE: final String resourceName = decisionDefinition.getResourceName();
	  ...
	  {
		  private readonly GetDeploymentDecisionModelCmd outerInstance;

		  private CommandContext commandContext;
		  private string deploymentId;
		  private string resourceName;

		  public CallableAnonymousInnerClass(GetDeploymentDecisionModelCmd outerInstance, CommandContext commandContext, string deploymentId, string resourceName)
		  {
