 ...
 */
namespace org.camunda.bpm.engine.impl.dmn.el
{

	using ElExpression = org.camunda.bpm.dmn.engine.impl.spi.el.ElExpression;
	...
	/// 
	/// </summary>
	public class ProcessEngineElProvider : ElProvider
	{
	  ...
	  public virtual ElExpression createExpression(string expression)
	  {
