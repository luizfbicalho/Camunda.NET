...
namespace org.camunda.bpm.engine.impl
{
	...
	public class NativeExecutionQueryImpl : AbstractNativeQuery<NativeExecutionQuery, Execution>, NativeExecutionQuery
	{
	 ...
	 //results ////////////////////////////////////////////////////////////////
	  ...
	  public override IList<Execution> executeList(CommandContext commandContext, IDictionary<string, object> parameterMap, int firstResult, int maxResults)
	  {
		return commandContext.ExecutionManager.findExecutionsByNativeQuery(parameterMap, firstResult, maxResults);
	  }
