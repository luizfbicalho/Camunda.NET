...
namespace org.camunda.bpm.container.impl.metadata
{
	...
	/// <summary>
	/// <para>Implementation of the <seealso cref="ProcessEnginePluginXml"/> descriptor</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
	public class ProcessEnginePluginXmlImpl : ProcessEnginePluginXml
	{

	  protected internal string pluginClass;
