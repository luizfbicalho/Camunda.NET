...
namespace org.camunda.bpm.application
{
	...
	public interface ProcessApplicationReference
	{
	  ...
	  ///           if the process application is unavailable </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public ProcessApplicationInterface getProcessApplication() throws ProcessApplicationUnavailableException;
	  ProcessApplicationInterface ProcessApplication {get;}
