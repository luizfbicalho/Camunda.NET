...
namespace org.camunda.bpm.engine.impl
{
	...
	/// <summary>
	/// Properties which can be used in <seealso cref="HistoricDecisionInstanceQuery"/> to sort historic decision instances.
	/// 
	...
	public static class HistoricDecisionInstanceQueryProperty_Fields
	{
	  public static readonly QueryProperty EVALUATION_TIME = new QueryPropertyImpl("EVAL_TIME_");
