...
namespace org.camunda.bpm.engine.@delegate
{
	...
	/// 
	/// </summary>
	public interface BaseDelegateExecution : VariableScope
	{

	  /// <summary>
	  /// Unique id of this path of execution that can be used as a handle to provide external signals back into the engine after wait states. </summary>
	  string Id {get;}
