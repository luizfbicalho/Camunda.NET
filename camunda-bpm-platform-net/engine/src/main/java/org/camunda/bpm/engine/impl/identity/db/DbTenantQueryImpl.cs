...
namespace org.camunda.bpm.engine.impl.identity.db
{
	...
	[Serializable]
	public class DbTenantQueryImpl : TenantQueryImpl
	{

	  private const long serialVersionUID = 1L;

	  public DbTenantQueryImpl() : base()
	  {
	  }

	  public DbTenantQueryImpl(CommandExecutor commandExecutor) : base(commandExecutor)
	  {
	  }
