...
namespace org.camunda.bpm.engine.impl.pvm.@delegate
{
	...
	/// </summary>
	public interface ModificationObserverBehavior : ActivityBehavior
	{
	  ...
	  /// </summary>
	  IList<ActivityExecution> initializeScope(ActivityExecution scopeExecution, int nrOfInnerInstances);
