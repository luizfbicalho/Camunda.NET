...
namespace org.camunda.bpm.engine.impl
{
	...
	public static class ProcessDefinitionQueryProperty_Fields
	{
	  public static readonly QueryProperty PROCESS_DEFINITION_KEY = new QueryPropertyImpl("KEY_");
	  public static readonly QueryProperty PROCESS_DEFINITION_CATEGORY = new QueryPropertyImpl("CATEGORY_");
