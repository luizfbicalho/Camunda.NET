...
//	import static org.junit.Assert.assertTrue;
	...
	/// 
	/// </summary>
	public class CaseTaskPlanItemHandlerTest : CmmnElementHandlerTest
	{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testCaseTaskActivityName()
	  public virtual void testCaseTaskActivityName()
	  {
		// given:
...
//ORIGINAL LINE: @Test public void testPlanItemActivityName()
	  public virtual void testPlanItemActivityName()
	  {
		...
		// then
		assertNotEquals(name, activity.Name);
		assertEquals(planItemName, activity.Name);
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testCaseTaskDescription()
	  public virtual void testCaseTaskDescription()
	  {
		// given
		string description = "This is a caseTask";
		caseTask.Description = description;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testCaseTaskActivityType()
	  public virtual void testCaseTaskActivityType()
	  {
		// given
...
//ORIGINAL LINE: @Test public void testActivityBehavior()
	  public virtual void testActivityBehavior()
	  {
		...
		assertTrue(behavior is CaseTaskActivityBehavior);
	  }
...
//ORIGINAL LINE: @Test public void testCallableElement()
	  public virtual void testCallableElement()
	  {
		...
		CaseTaskActivityBehavior behavior = (CaseTaskActivityBehavior) activity.ActivityBehavior;

		assertNotNull(behavior.CallableElement);
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testCaseRefConstant()
	  public virtual void testCaseRefConstant()
	  {
		// given:
		string caseRef = "aCaseToCall";
		caseTask.Case = caseRef;
		...
		assertTrue(caseRefValueProvider is ConstantValueProvider);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testCaseRefExpression()
	  public virtual void testCaseRefExpression()
	  {
		// given:
		string caseRef = "${aCaseToCall}";
		caseTask.Case = caseRef;
		...
		assertEquals(caseRef, valueProvider.Expression.ExpressionText);
	  }
...
//ORIGINAL LINE: @Test public void testBinding()
	  public virtual void testBinding()
	  {
		...
		caseTask.CamundaCaseBinding = caseBinding.Value;
...
//ORIGINAL LINE: @Test public void testVersionConstant()
	  public virtual void testVersionConstant()
	  {
		...
		caseTask.CamundaCaseVersion = caseVersion;
...
//ORIGINAL LINE: @Test public void testManualActivationRuleByDefaultPlanItemControl()
	  ...
	  {
		// given
		PlanItemControl defaultControl = createElement(caseTask, "ItemControl_1", typeof(DefaultControl));
...
//ORIGINAL LINE: @Test public void testRepetitionRuleStandardEventsByDefaultPlanItemControl()
	  ...
	  {
		// given
		PlanItemControl defaultControl = createElement(caseTask, "DefaultControl_1", typeof(DefaultControl));
