...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	public class HistoryCleanupSchedulerActivityInstancesTest : AbstractHistoryCleanupSchedulerTest
	{
		private bool InstanceFieldsInitialized = false;

		public HistoryCleanupSchedulerActivityInstancesTest()
		{
	  ...
	  private class ProcessEngineBootstrapRuleAnonymousInnerClass : ProcessEngineBootstrapRule
	  {
		  ...
		  {
			return outerInstance.configure(configuration, HistoryEventTypes.ACTIVITY_INSTANCE_START);
		  }
	  }
