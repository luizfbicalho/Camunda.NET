 ...
 */
namespace org.camunda.bpm.engine.test.bpmn.@event
{
	...
	public class IntermediateNoneEventTest : PluggableProcessEngineTestCase
	{
	  ...
	  public class MyExecutionListener : ExecutionListener
	  {
...
//ORIGINAL LINE: @Deployment public void testIntermediateNoneTimerEvent() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
