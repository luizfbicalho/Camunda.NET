...
namespace org.camunda.bpm.engine.test.bpmn.executionlistener
{
	...
	/// <summary>
	/// Simple <seealso cref="ExecutionListener"/> that sets a variable on the execution depending on the execution's state.
	/// 
	/// @author Tobias Metzke
	/// </summary>
	public class ExampleExecutionListenerEnd : ExecutionListener
	{
...
//ORIGINAL LINE: public void notify(org.camunda.bpm.engine.delegate.DelegateExecution execution) throws Exception
	  ...
	  {
		bool instanceEnded = execution.BpmnModelElementInstance is EndEvent;
		bool instanceCanceled = execution.ProcessInstance != null && execution.ProcessInstance.Canceled;
		if (instanceCanceled)
		{
