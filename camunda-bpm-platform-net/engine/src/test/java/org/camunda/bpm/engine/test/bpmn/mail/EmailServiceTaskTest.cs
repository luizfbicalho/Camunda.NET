...
namespace org.camunda.bpm.engine.test.bpmn.mail
{
	...
	/// @author Joram Barrez
	/// </summary>
	public class EmailServiceTaskTest : EmailTestCase
	{
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static String getMessage(javax.mail.internet.MimeMessage mimeMessage) throws javax.mail.MessagingException, java.io.IOException
