...
//ORIGINAL LINE: @RunWith(Parameterized.class) public class StagePlanItemExecutionListenerHandlerTest extends CmmnElementHandlerTest
	public class StagePlanItemExecutionListenerHandlerTest : CmmnElementHandlerTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
