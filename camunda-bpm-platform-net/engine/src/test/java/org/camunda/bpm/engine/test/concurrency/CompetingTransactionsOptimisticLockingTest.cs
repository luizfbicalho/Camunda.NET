...
namespace org.camunda.bpm.engine.test.concurrency
{
	...
	/// </summary>
	public class CompetingTransactionsOptimisticLockingTest : PluggableProcessEngineTestCase
	{
	  ...
	  {
		  private readonly CompetingTransactionsOptimisticLockingTest outerInstance;

		internal string taskId;
		internal ProcessEngineException exception;

		public TransactionThread(CompetingTransactionsOptimisticLockingTest outerInstance, string taskId)
		{
...
//ORIGINAL LINE: @Deployment public void testCompetingTransactionsOptimisticLocking() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
