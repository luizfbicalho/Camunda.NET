...
namespace org.camunda.bpm.engine.test.api.authorization.service
{
	...
	/// 
	/// </summary>
	public abstract class MyServiceTaskActivityBehavior : MyDelegationService, SignallableActivityBehavior
	{
		public abstract void execute(ActivityExecution execution);
