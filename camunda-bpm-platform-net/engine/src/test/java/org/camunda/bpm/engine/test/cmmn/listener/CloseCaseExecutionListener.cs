...
namespace org.camunda.bpm.engine.test.cmmn.listener
{
	...
	/// </summary>
	[Serializable]
	public class CloseCaseExecutionListener : CaseExecutionListener
	{

	  private const long serialVersionUID = 1L;

	  protected internal static string EVENT;
	  protected internal static int COUNTER = 0;
	  protected internal static string ON_CASE_EXECUTION_ID;
