...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	public class HistoryCleanupSchedulerUserOperationLogsTest : AbstractHistoryCleanupSchedulerTest
	{
		private bool InstanceFieldsInitialized = false;

		public HistoryCleanupSchedulerUserOperationLogsTest()
		{
		...
		private void InitializeInstanceFields()
		{
			...
			PROCESS = Bpmn.createExecutableProcess(PROCESS_KEY).camundaHistoryTimeToLive(5).startEvent().camundaAsyncBefore().endEvent().done();
		}
	  ...
	  private class ProcessEngineBootstrapRuleAnonymousInnerClass : ProcessEngineBootstrapRule
	  {
		  ...
		  {
			return outerInstance.configure(configuration, HistoryEventTypes.USER_OPERATION_LOG);
		  }
	  }
