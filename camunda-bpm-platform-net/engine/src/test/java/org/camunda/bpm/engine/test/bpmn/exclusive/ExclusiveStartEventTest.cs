...
namespace org.camunda.bpm.engine.test.bpmn.exclusive
{
	...
	/// </summary>
	public class ExclusiveStartEventTest : PluggableProcessEngineTestCase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deployment public void testNonExclusiveStartEvent()
	  public virtual void testNonExclusiveStartEvent()
	  {
		// start process 
