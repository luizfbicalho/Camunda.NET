...
namespace org.camunda.bpm.engine.test.cmmn.operation
{
	...
	/// 
	/// </summary>
	public class CaseExecutionTerminationTest : PvmTestCase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testTerminateCaseInstance()
	  public virtual void testTerminateCaseInstance()
	  {
		...
		assertTrue(stageX.Terminated);
		assertTrue(taskA.Terminated);
		assertTrue(taskB.Terminated);
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testTerminateStage()
	  public virtual void testTerminateStage()
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testTerminateTask()
	  public virtual void testTerminateTask()
	  {
