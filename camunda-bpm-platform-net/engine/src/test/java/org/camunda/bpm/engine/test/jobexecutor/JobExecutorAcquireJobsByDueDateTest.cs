...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Deployment(resources = { "org/camunda/bpm/engine/test/jobexecutor/simpleAsyncProcess.bpmn20.xml", "org/camunda/bpm/engine/test/jobexecutor/processWithTimerCatch.bpmn20.xml" }) public void testOldJobsArePreferred()
	  ...
	  public virtual void testOldJobsArePreferred()
	  {
		...
		assertEquals(messageJob1.Id, acquirableJobs[0].Id);
		assertEquals(timerJob1.Id, acquirableJobs[1].Id);
		assertEquals(timerJob2.Id, acquirableJobs[2].Id);
