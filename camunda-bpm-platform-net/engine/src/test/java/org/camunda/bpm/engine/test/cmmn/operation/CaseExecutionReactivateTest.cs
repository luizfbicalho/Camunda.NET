...
namespace org.camunda.bpm.engine.test.cmmn.operation
{
	...
	/// 
	/// </summary>
	public class CaseExecutionReactivateTest : PvmTestCase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testReactivateCaseInstance()
	  public virtual void testReactivateCaseInstance()
	  {
