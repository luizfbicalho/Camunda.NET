...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	public class HistoryCleanupSchedulerIdentityLinkLogsTest : AbstractHistoryCleanupSchedulerTest
	{
		private bool InstanceFieldsInitialized = false;

		public HistoryCleanupSchedulerIdentityLinkLogsTest()
		{
	  ...
	  private class ProcessEngineBootstrapRuleAnonymousInnerClass : ProcessEngineBootstrapRule
	  {
		  ...
		  {
			return outerInstance.configure(configuration, HistoryEventTypes.TASK_INSTANCE_CREATE, HistoryEventTypes.IDENTITY_LINK_ADD);
		  }
	  }
