...
namespace org.camunda.bpm.engine.test.bpmn.servicetask.util
{
	...
	/// </summary>
	public class BusinessKeyCheckJavaDelegate : JavaDelegate
	{
...
//ORIGINAL LINE: public void execute(org.camunda.bpm.engine.delegate.DelegateExecution execution) throws Exception
	  ...
	  {
		execution.setVariable("businessKeySetOnExecution", execution.ProcessBusinessKey);
		execution.setVariable("businessKeyAsProcessBusinessKey", execution.BusinessKey);
	  }
	}
