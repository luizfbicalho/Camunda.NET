...
namespace org.camunda.bpm.engine.test.standalone.interceptor
{
	...
	/// 
	/// </summary>
	public class StartProcessInstanceOnEngineDelegate : JavaDelegate
	{

	  public static IDictionary<string, ProcessEngine> ENGINES = new Dictionary<string, ProcessEngine>();
