...
namespace org.camunda.bpm.engine.test.concurrency
{
	...
	/// @author Tom Baeyens
	/// </summary>
	public class CompetingProcessCompletionTest : PluggableProcessEngineTestCase
	{
	...
	private static Logger LOG = ProcessEngineLogger.TEST_LOGGER.Logger;
	  ...
	  {
		  private readonly CompetingProcessCompletionTest outerInstance;

		internal string taskId;
		internal OptimisticLockingException exception;
		public CompleteTaskThread(CompetingProcessCompletionTest outerInstance, string taskId)
		{
...
//ORIGINAL LINE: @Deployment public void testCompetingEnd() throws Exception
