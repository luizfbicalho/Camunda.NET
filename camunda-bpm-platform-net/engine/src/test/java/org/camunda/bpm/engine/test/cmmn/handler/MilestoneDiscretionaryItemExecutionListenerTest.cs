...
//ORIGINAL LINE: @RunWith(Parameterized.class) public class MilestoneDiscretionaryItemExecutionListenerTest extends CmmnElementHandlerTest
	public class MilestoneDiscretionaryItemExecutionListenerTest : CmmnElementHandlerTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
