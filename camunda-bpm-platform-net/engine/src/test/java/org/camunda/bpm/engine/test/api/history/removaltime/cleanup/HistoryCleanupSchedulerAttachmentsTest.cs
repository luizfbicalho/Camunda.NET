...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	public class HistoryCleanupSchedulerAttachmentsTest : AbstractHistoryCleanupSchedulerTest
	{
		private bool InstanceFieldsInitialized = false;

		public HistoryCleanupSchedulerAttachmentsTest()
		{
	  ...
	  private class ProcessEngineBootstrapRuleAnonymousInnerClass : ProcessEngineBootstrapRule
	  {
		  ...
		  {
			return outerInstance.configure(configuration);
		  }
	  }
