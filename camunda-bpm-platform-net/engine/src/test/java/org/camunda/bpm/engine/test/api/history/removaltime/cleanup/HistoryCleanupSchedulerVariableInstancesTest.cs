...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	public class HistoryCleanupSchedulerVariableInstancesTest : AbstractHistoryCleanupSchedulerTest
	{
		private bool InstanceFieldsInitialized = false;

		public HistoryCleanupSchedulerVariableInstancesTest()
		{
	  ...
	  private class ProcessEngineBootstrapRuleAnonymousInnerClass : ProcessEngineBootstrapRule
	  {
		  ...
		  {
			return outerInstance.configure(configuration, HistoryEventTypes.VARIABLE_INSTANCE_CREATE);
		  }
	  }
