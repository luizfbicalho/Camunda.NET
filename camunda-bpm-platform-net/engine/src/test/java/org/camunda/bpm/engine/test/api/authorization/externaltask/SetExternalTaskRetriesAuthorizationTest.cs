...
//ORIGINAL LINE: @RunWith(Parameterized.class) public class SetExternalTaskRetriesAuthorizationTest
	public class SetExternalTaskRetriesAuthorizationTest
	{
		private bool InstanceFieldsInitialized = false;

		public SetExternalTaskRetriesAuthorizationTest()
		{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Deployment(resources = "org/camunda/bpm/engine/test/api/externaltask/oneExternalTaskProcess.bpmn20.xml") public void testSetRetries()
	  ...
	  public virtual void testSetRetries()
	  {
		...
		ExternalTask task = engineRule.ExternalTaskService.createExternalTaskQuery().singleResult();
		...
		{
		  task = engineRule.ExternalTaskService.createExternalTaskQuery().singleResult();
