 ...
 */
namespace org.camunda.bpm.engine.test.api.authorization.job
{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Deployment(resources = "org/camunda/bpm/engine/test/api/authorization/oneIncidentProcess.bpmn20.xml") public void testSetJobPriority()
	  ...
	  public virtual void testSetJobPriority()
	  {
		...
		{
		  Job updatedJob = engineRule.ManagementService.createJobQuery().singleResult();
		  Assert.assertEquals(42, updatedJob.Priority);
		}
