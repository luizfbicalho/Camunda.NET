...
namespace org.camunda.bpm.engine.test.standalone.pvm
{
	...
	/// 
	/// </summary>
	public class PvmActivityInstanceCompleteTest : PvmTestCase
	{
	  ...
	  public virtual void testTwoEnds()
	  {
		...
		PvmProcessDefinition processDefinition = (new ProcessDefinitionBuilder()).createActivity("start").initial().behavior(new Automatic()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("fork").endActivity().createActivity("fork").behavior(new ParallelGateway()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("end1").transition("end2").endActivity().createActivity("end1").behavior(new End()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).endActivity().createActivity("end2").behavior(new End()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).endActivity().buildProcessDefinition();
	  ...
	  public virtual void testSingleEndAfterParallelJoin()
	  {
		...
		PvmProcessDefinition processDefinition = (new ProcessDefinitionBuilder()).createActivity("start").initial().behavior(new Automatic()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("fork").endActivity().createActivity("fork").behavior(new ParallelGateway()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("a1").transition("a2").endActivity().createActivity("a1").behavior(new Automatic()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("join").endActivity().createActivity("a2").behavior(new Automatic()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("join").endActivity().createActivity("join").behavior(new ParallelGateway()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("end").endActivity().createActivity("end").behavior(new End()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).endActivity().buildProcessDefinition();
	  ...
	  public virtual void testBoundaryEvent()
	  {
		...
		PvmProcessDefinition processDefinition = (new ProcessDefinitionBuilder()).createActivity("start").initial().behavior(new Automatic()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("userTask").endActivity().createActivity("userTask").scope().behavior(new EmbeddedSubProcess()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).transition("end1").endActivity().createActivity("timer").behavior(new WaitState()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).attachedTo("userTask", true).transition("end2").endActivity().createActivity("end1").behavior(new End()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).endActivity().createActivity("end2").behavior(new End()).executionListener(org.camunda.bpm.engine.@delegate.ExecutionListener_Fields.EVENTNAME_END, verifier).endActivity().buildProcessDefinition();
