...
//ORIGINAL LINE: @RunWith(Parameterized.class) public class HumanTaskDicretionaryItemExecutionListenerHandlerTest extends CmmnElementHandlerTest
	public class HumanTaskDicretionaryItemExecutionListenerHandlerTest : CmmnElementHandlerTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
