...
//	import static org.camunda.bpm.engine.test.util.ExecutionAssert.describeExecutionTree;
	...
	public class ProcessInstanceModificationEventTest : PluggableProcessEngineTestCase
	{
	  ...
	  protected internal const string INTERMEDIATE_TIMER_CATCH_PROCESS = "org/camunda/bpm/engine/test/api/runtime/ProcessInstanceModificationTest.intermediateTimerCatch.bpmn20.xml";
	  protected internal const string MESSAGE_START_EVENT_PROCESS = "org/camunda/bpm/engine/test/api/runtime/ProcessInstanceModificationTest.messageStart.bpmn20.xml";
	  protected internal const string TIMER_START_EVENT_PROCESS = "org/camunda/bpm/engine/test/api/runtime/ProcessInstanceModificationTest.timerStart.bpmn20.xml";
	  protected internal const string ONE_TASK_PROCESS = "org/camunda/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml";
	  protected internal const string TERMINATE_END_EVENT_PROCESS = "org/camunda/bpm/engine/test/api/runtime/ProcessInstanceModificationTest.terminateEnd.bpmn20.xml";
	  protected internal const string CANCEL_END_EVENT_PROCESS = "org/camunda/bpm/engine/test/api/runtime/ProcessInstanceModificationTest.cancelEnd.bpmn20.xml";
	  ...
	  public virtual void testStartBeforeMessageStartEvent()
	  {
		...
		assertEquals(startEventSubscription.Id, subscription.Id);
	  ...
	  public virtual void testStartBeforeTerminateEndEvent()
	  {
		...
		runtimeService.createProcessInstanceModification(processInstanceId).startBeforeActivity("terminateEnd").execute();
