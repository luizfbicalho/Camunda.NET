...
//ORIGINAL LINE: @Test public void shouldInitHistoryLevelByObject() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void shouldInitHistoryLevelByObject()
	  {
		ProcessEngineConfigurationImpl config = createConfig();
		config.HistoryLevel = org.camunda.bpm.engine.impl.history.HistoryLevel_Fields.HISTORY_LEVEL_FULL;
