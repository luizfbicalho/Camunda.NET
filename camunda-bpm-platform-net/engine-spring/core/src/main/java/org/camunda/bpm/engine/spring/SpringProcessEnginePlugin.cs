...
namespace org.camunda.bpm.engine.spring
{
	...
	/// <summary>
	/// This is bean-name-aware extension of the <seealso cref="AbstractProcessEnginePlugin"/> allowing anonymous
	/// classes get logged correctly when processed.
	/// </summary>
	public class SpringProcessEnginePlugin : AbstractProcessEnginePlugin, BeanNameAware
	{

	  protected internal string beanName;

	  public override string BeanName
	  {
		  set
		  {
			this.beanName = value;
