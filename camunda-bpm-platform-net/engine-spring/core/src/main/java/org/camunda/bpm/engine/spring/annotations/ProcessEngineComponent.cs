...
namespace org.camunda.bpm.engine.spring.annotations
{
	...
	/// (optionally) <seealso cref="ProcessEngineComponent"/> and, on a method, add
	/// <seealso cref="State"/> to indicate that the method in particular is
	/// tasked with responding to a state. If applied to a bean and there are no <seealso cref="org.camunda.bpm.engine.ProcessEngineComponent.ActivitiComponent"/>
...
//ORIGINAL LINE: @Target({ElementType.TYPE}) @Retention(RetentionPolicy.RUNTIME) @Documented public class ProcessEngineComponent extends System.Attribute
	[AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
	public class ProcessEngineComponent : System.Attribute
	{
		internal string processKey;

		public ProcessEngineComponent(String processKey = "")
		{
