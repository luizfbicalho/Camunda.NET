...
{
	using NamespaceHandlerSupport = org.springframework.beans.factory.xml.NamespaceHandlerSupport;
	...
	/// @since 5.3
	/// </summary>
	public class ActivitiNamespaceHandler : NamespaceHandlerSupport
	{
