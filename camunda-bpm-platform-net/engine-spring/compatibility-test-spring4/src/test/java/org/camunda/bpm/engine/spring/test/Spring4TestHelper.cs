...
namespace org.camunda.bpm.engine.spring.test
{
	...
	/// </summary>
	public class Spring4TestHelper : SpringTestHelper
	{
	  ...
	  {
		  private readonly Spring4TestHelper outerInstance;

		  public TestExecutionListenerAnonymousInnerClass(Spring4TestHelper outerInstance)
		  {
