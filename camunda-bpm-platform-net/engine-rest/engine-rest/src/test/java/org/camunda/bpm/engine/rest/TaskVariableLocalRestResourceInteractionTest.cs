...
//	import static org.mockito.Mockito.when;
	...
	/// 
	/// </summary>
	public class TaskVariableLocalRestResourceInteractionTest : AbstractRestServiceTest
	{
...
//ORIGINAL LINE: @ClassRule public static org.camunda.bpm.engine.rest.util.container.TestContainerRule rule = new org.camunda.bpm.engine.rest.util.container.TestContainerRule();
	  ...
	  protected internal static readonly string SINGLE_TASK_VARIABLES_URL = SINGLE_TASK_URL + "/localVariables";
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		...
		when(taskServiceMock.getVariablesLocalTyped(eq(EXAMPLE_TASK_ID), anyBoolean())).thenReturn(Variables.createVariables().putValueTyped(variableKey, variableValue));
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testGetLocalVariablesForNonExistingTaskId()
	  public virtual void testGetLocalVariablesForNonExistingTaskId()
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testLocalVariableModificationForNonExistingTaskId()
	  public virtual void testLocalVariableModificationForNonExistingTaskId()
	  {
		TaskServiceImpl taskServiceMock = mockTaskServiceImpl();
		doThrow(new ProcessEngineException("Cannot find task with id " + NON_EXISTING_ID)).when(taskServiceMock).updateVariablesLocal(anyString(), any(typeof(System.Collections.IDictionary)), any(typeof(System.Collections.IList)));
...
//ORIGINAL LINE: @Test public void testVariableModificationThrowsAuthorizationException()
	  public virtual void testVariableModificationThrowsAuthorizationException()
	  {
		...
		doThrow(new AuthorizationException(message)).when(taskServiceMock).updateVariablesLocal(anyString(), any(typeof(System.Collections.IDictionary)), any(typeof(System.Collections.IList)));
...
//ORIGINAL LINE: @Test public void testGetSingleLocalVariable()
	  public virtual void testGetSingleLocalVariable()
	  {
		...
		when(taskServiceMock.getVariableLocalTyped(eq(EXAMPLE_TASK_ID), eq(variableKey), anyBoolean())).thenReturn(Variables.integerValue(variableValue));
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testGetLocalVariableForNonExistingTaskId()
	  public virtual void testGetLocalVariableForNonExistingTaskId()
	  {
		string variableKey = "aVariableKey";
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testGetSingleLocalVariableThrowsAuthorizationException()
	  public virtual void testGetSingleLocalVariableThrowsAuthorizationException()
	  {
		string variableKey = "aVariableKey";
...
//ORIGINAL LINE: @Test public void testPutSingleLocalVariable()
	  public virtual void testPutSingleLocalVariable()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsUntypedValue.matcher().value(variableValue)));
	  }
...
//ORIGINAL LINE: @Test public void testPutSingleVariableWithTypeInteger()
	  public virtual void testPutSingleVariableWithTypeInteger()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.integerValue(variableValue)));
	  }
...
//ORIGINAL LINE: @Test public void testPutSingleVariableWithTypeShort()
	  public virtual void testPutSingleVariableWithTypeShort()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.shortValue(variableValue)));
	  }
...
//ORIGINAL LINE: @Test public void testPutSingleVariableWithTypeLong()
	  public virtual void testPutSingleVariableWithTypeLong()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.longValue(variableValue)));
	  }
...
//ORIGINAL LINE: @Test public void testPutSingleVariableWithTypeDouble()
	  public virtual void testPutSingleVariableWithTypeDouble()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.doubleValue(variableValue)));
	  }
...
//ORIGINAL LINE: @Test public void testPutSingleVariableWithTypeBoolean()
	  public virtual void testPutSingleVariableWithTypeBoolean()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.booleanValue(variableValue)));
	  }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPutSingleVariableWithTypeDate()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.dateValue(expectedValue)));
	  }
...
//ORIGINAL LINE: @Test public void testPutSingleLocalVariableWithNoValue()
	  public virtual void testPutSingleLocalVariableWithNoValue()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsNullValue.matcher()));
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPutLocalVariableForNonExistingTaskId()
	  public virtual void testPutLocalVariableForNonExistingTaskId()
	  {
		string variableKey = "aVariableKey";
		string variableValue = "aVariableValue";
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostSingleLocalBinaryVariable() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPostSingleLocalBinaryVariable()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsPrimitiveValue.bytesValue(bytes)));
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostSingleLocalBinaryVariableWithValueType() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPostSingleLocalBinaryVariableWithValueType()
	  {
		sbyte[] bytes = "someContent".GetBytes();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostSingleLocalBinaryVariableWithNoValue() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPostSingleLocalBinaryVariableWithNoValue()
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostSingleLocalSerializableVariable() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPostSingleLocalSerializableVariable()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(MockProvider.EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsObjectValue.objectValueMatcher().Deserialized.value(serializable)));
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPostSingleLocalSerializableVariableUnsupportedMediaType() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPostSingleLocalSerializableVariableUnsupportedMediaType()
	  {
		...
		verify(taskServiceMock, never()).setVariableLocal(eq(EXAMPLE_TASK_ID), eq(variableKey), eq(serializable));
	  }
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPutSingleLocalVariableFromSerialized() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testPutSingleLocalVariableFromSerialized()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(MockProvider.EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsObjectValue.objectValueMatcher().serializedValue(serializedValue).serializationFormat("aDataFormat").objectTypeName("aRootType")));
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testPutSingleLocalVariableFromInvalidSerialized() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
...
//ORIGINAL LINE: @Test public void testPutSingleLocalVariableFromSerializedWithNoValue()
	  public virtual void testPutSingleLocalVariableFromSerializedWithNoValue()
	  {
		...
		verify(taskServiceMock).setVariableLocal(eq(MockProvider.EXAMPLE_TASK_ID), eq(variableKey), argThat(EqualsObjectValue.objectValueMatcher()));
	  }
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testDeleteLocalVariableForNonExistingTaskId()
	  public virtual void testDeleteLocalVariableForNonExistingTaskId()
	  {
		string variableKey = "aVariableKey";

		doThrow(new ProcessEngineException("Cannot find task with id " + NON_EXISTING_ID)).when(taskServiceMock).removeVariableLocal(eq(NON_EXISTING_ID), eq(variableKey));
