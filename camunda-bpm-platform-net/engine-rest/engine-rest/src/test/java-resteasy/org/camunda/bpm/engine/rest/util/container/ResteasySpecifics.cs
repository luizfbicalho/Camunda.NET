...
namespace org.camunda.bpm.engine.rest.util.container
{
	...
	using NoServletAuthenticationFilterTest = org.camunda.bpm.engine.rest.standalone.NoServletAuthenticationFilterTest;
	using NoServletEmptyBodyFilterTest = org.camunda.bpm.engine.rest.standalone.NoServletEmptyBodyFilterTest;
	using ServletAuthenticationFilterTest = org.camunda.bpm.engine.rest.standalone.ServletAuthenticationFilterTest;
	using ServletEmptyBodyFilterTest = org.camunda.bpm.engine.rest.standalone.ServletEmptyBodyFilterTest;
	...
	/// 
	/// </summary>
	public class ResteasySpecifics : ContainerSpecifics
	{
	  ...
	  public class EmbeddedServerRuleFactory : TestRuleFactory
	  {
		...
		private class ExternalResourceAnonymousInnerClass : ExternalResource
		{
			...
			public ExternalResourceAnonymousInnerClass(EmbeddedServerRuleFactory outerInstance)
			{
				...
				bootstrap = new ResteasyServerBootstrap(outerInstance.jaxRsApplication);
			}


			internal ResteasyServerBootstrap bootstrap;
...
//ORIGINAL LINE: final org.junit.rules.TemporaryFolder tempFolder = new org.junit.rules.TemporaryFolder();
		...
		private class ExternalResourceAnonymousInnerClass : ExternalResource
		{
			...
			public ExternalResourceAnonymousInnerClass(ServletContainerRuleFactory outerInstance, TemporaryFolder tempFolder)
			{
				...
				bootstrap = new ResteasyTomcatServerBootstrap(outerInstance.webXmlResource);
			}


			internal ResteasyTomcatServerBootstrap bootstrap;
