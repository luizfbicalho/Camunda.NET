...
namespace org.camunda.bpm.engine.rest.dto.migration
{
	...
	public class MigratingProcessInstanceValidationExceptionDto : ExceptionDto
	{

	  protected internal MigratingProcessInstanceValidationReportDto validationReport;

	  public virtual MigratingProcessInstanceValidationReportDto ValidationReport
	  {
		  get
		  {
