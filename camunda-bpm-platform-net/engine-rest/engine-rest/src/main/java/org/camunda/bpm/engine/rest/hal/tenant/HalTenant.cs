...
namespace org.camunda.bpm.engine.rest.hal.tenant
{
	...
	public class HalTenant : HalResource<HalTenant>, HalIdResource
	{

	  public static readonly HalRelation REL_SELF = HalRelation.build("self", typeof(TenantRestService), UriBuilder.fromPath(org.camunda.bpm.engine.rest.TenantRestService_Fields.PATH).path("{id}"));
