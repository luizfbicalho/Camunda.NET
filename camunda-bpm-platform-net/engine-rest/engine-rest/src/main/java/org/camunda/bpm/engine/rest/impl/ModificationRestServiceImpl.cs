...
namespace org.camunda.bpm.engine.rest.impl
{
	...
	public class ModificationRestServiceImpl : AbstractRestProcessEngineAware, ModificationRestService
	{

	  public ModificationRestServiceImpl(string engineName, ObjectMapper objectMapper) : base(engineName, objectMapper)
	  {
	  }
