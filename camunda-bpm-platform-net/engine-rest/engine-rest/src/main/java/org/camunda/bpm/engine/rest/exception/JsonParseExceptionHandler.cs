...
//ORIGINAL LINE: @Provider public class JsonParseExceptionHandler implements javax.ws.rs.ext.ExceptionMapper<com.fasterxml.jackson.core.JsonParseException>
	public class JsonParseExceptionHandler : ExceptionMapper<JsonParseException>
	{
		public override Response toResponse(JsonParseException exception)
		{
