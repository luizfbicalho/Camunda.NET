...
namespace org.camunda.bpm.engine.rest.dto.converter
{
	...
	public class DelegationStateConverter : JacksonAwareStringToTypeConverter<DelegationState>
	{

	  public override DelegationState convertQueryParameterToType(string value)
	  {
		try
		{
		  return Enum.Parse(typeof(DelegationState), value.ToUpper());
