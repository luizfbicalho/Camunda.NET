...
namespace org.camunda.bpm.engine.rest.dto.history.batch.removaltime
{
	...
	/// </summary>
	public class SetRemovalTimeToHistoricProcessInstancesDto : AbstractSetRemovalTimeDto
	{

	  protected internal string[] historicProcessInstanceIds;
	  protected internal HistoricProcessInstanceQueryDto historicProcessInstanceQuery;
	  protected internal bool hierarchical;

	  public virtual string[] HistoricProcessInstanceIds
	  {
		  get
		  {
