...
namespace org.camunda.bpm.engine.rest.sub.runtime.impl
{
	...
	/// 
	/// </summary>
	public class LocalCaseExecutionVariablesResource : AbstractVariablesResource
	{

	  public LocalCaseExecutionVariablesResource(ProcessEngine engine, string resourceId, ObjectMapper objectMapper) : base(engine, resourceId, objectMapper)
	  {
	  }
