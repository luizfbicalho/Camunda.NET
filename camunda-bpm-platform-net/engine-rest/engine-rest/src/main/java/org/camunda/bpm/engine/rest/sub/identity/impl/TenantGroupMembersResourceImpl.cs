...
//	import static org.camunda.bpm.engine.authorization.Permissions.DELETE;
	...
	public class TenantGroupMembersResourceImpl : AbstractIdentityResource, TenantGroupMembersResource
	{
	  ...
	  public virtual void createMembership(string groupId)
	  {
		ensureNotReadOnly();
	  ...
	  public virtual void deleteMembership(string groupId)
	  {
		ensureNotReadOnly();
	  ...
	  public virtual ResourceOptionsDto availableOperations(UriInfo context)
	  {
		...
		URI uri = context.BaseUriBuilder.path(relativeRootResourcePath).path(org.camunda.bpm.engine.rest.TenantRestService_Fields.PATH).path(resourceId).path(org.camunda.bpm.engine.rest.sub.identity.TenantGroupMembersResource_Fields.PATH).build();
