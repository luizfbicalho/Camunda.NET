...
//ORIGINAL LINE: @GET @Produces(javax.ws.rs.core.MediaType.APPLICATION_JSON) org.camunda.bpm.engine.rest.dto.runtime.CaseInstanceDto getCaseInstance();
	  CaseInstanceDto CaseInstance {get;}
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @POST @Path("/close") @Consumes(javax.ws.rs.core.MediaType.APPLICATION_JSON) void close(org.camunda.bpm.engine.rest.dto.runtime.CaseExecutionTriggerDto triggerDto);
