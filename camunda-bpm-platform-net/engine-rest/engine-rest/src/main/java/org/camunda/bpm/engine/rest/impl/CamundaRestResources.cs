...
namespace org.camunda.bpm.engine.rest.impl
{
	...
	/// <summary>
	/// <para>Class providing static methods returning all the resource classes provided by camunda BPM.</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
	public class CamundaRestResources
	{
	  ...
	  {
		RESOURCE_CLASSES.Add(typeof(NamedProcessEngineRestServiceImpl));
		RESOURCE_CLASSES.Add(typeof(DefaultProcessEngineRestServiceImpl));
