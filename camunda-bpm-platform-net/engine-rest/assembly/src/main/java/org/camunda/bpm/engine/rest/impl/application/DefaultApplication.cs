...
namespace org.camunda.bpm.engine.rest.impl.application
{
	...
	/// <summary>
	/// <para>Default <seealso cref="Application"/> registering all resources.</para>
	/// 
	/// <para><strong>NOTE</strong> This class is excluded from the classes-jar,
...
//ORIGINAL LINE: @ApplicationPath("/") public class DefaultApplication extends javax.ws.rs.core.Application
