...
namespace org.camunda.bpm.container.impl.threading.ra.commonj
{
	...
	/// 
	/// </summary>
	public class CommonjDeamonWorkRunnableAdapter : Work
	{

	  protected internal readonly ThreadStart runnable;

	  public CommonjDeamonWorkRunnableAdapter(ThreadStart runnable)
	  {
