 ...
 */
namespace org.camunda.spin.plugin.variable.value.builder
{
	...
	/// 
	/// </summary>
	public interface SpinValueBuilder<T> : TypedValueBuilder<T> where T : org.camunda.spin.plugin.variable.value.SpinValue
	{
