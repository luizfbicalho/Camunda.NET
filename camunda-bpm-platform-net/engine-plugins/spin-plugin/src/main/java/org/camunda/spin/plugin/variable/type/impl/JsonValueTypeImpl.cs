...
namespace org.camunda.spin.plugin.variable.type.impl
{
	...
	/// 
	/// </summary>
	public class JsonValueTypeImpl : SpinValueTypeImpl, JsonValueType
	{

	  private const long serialVersionUID = 1L;

	  public JsonValueTypeImpl() : base(org.camunda.spin.plugin.variable.type.JsonValueType_Fields.TYPE_NAME)
	  {
	  }

	  protected internal override JsonValueBuilder createValue(SpinValue value)
	  {
		return SpinValues.jsonValue((SpinJsonNode) value);
	  }

	  protected internal override JsonValueBuilder createValueFromSerialized(string value)
	  {
