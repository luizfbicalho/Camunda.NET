...
namespace org.camunda.bpm.identity.impl.ldap.posix
{
	...
	/// 
	/// </summary>
	public abstract class LdapPosixTest : ResourceProcessEngineTestCase
	{

	  public LdapPosixTest() : base("posix.camunda.cfg.xml")
	  {
	  }

	  protected internal static LdapPosixTestEnvironment ldapTestEnvironment;
