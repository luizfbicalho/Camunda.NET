...
namespace org.camunda.bpm.identity.impl.ldap
{
	...
	/// 
	/// </summary>
	public class LdapAuthenticationException : IdentityProviderException
	{

	  private const long serialVersionUID = 1L;

	  public LdapAuthenticationException(string message, Exception cause) : base(message, cause)
	  {
	  }
