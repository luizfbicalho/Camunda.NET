...
namespace org.camunda.bpm.qa.upgrade.timestamp
{
	...
	/// </summary>
	public class MeterLogTimestampScenario : AbstractTimestampMigrationScenario
	{

	  protected internal const string REPORTER_NAME = "MeterLogTimestampTest";

	  [DescribesScenario("initMeterLogTimestamp"), Times(1)]
	  ...
	  private class ScenarioSetupAnonymousInnerClass : ScenarioSetup
	  {
		  ...
		  private class CommandAnonymousInnerClass : Command<Void>
		  {
			  ...
			  public Void execute(CommandContext commandContext)
			  {
				...
				commandContext.MeterLogManager.insert(new MeterLogEntity(REPORTER_NAME, REPORTER_NAME, 1L, TIMESTAMP));
