...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	[ScenarioUnderTest("EventSubscriptionCreateTimeScenario"), Origin("7.11.0")]
	public class EventSubscriptionCreateTimeTest : AbstractTimestampMigrationTest
	{

	  protected internal const string EVENT_NAME = "createTimeTestMessage";

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @ScenarioUnderTest("initEventSubscriptionCreateTime.1") @Test public void testCreateTimeConversion()
