...
//	import static org.junit.Assert.assertThat;
	...
	/// </summary>
	[ScenarioUnderTest("TaskCreateTimeScenario"), Origin("7.11.0")]
	public class TaskCreateTimeTest : AbstractTimestampMigrationTest
	{

	  protected internal const string TASK_NAME = "createTimeTestTask";

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @ScenarioUnderTest("initCreateTime.1") @Test public void testCreateTimeConversion()
