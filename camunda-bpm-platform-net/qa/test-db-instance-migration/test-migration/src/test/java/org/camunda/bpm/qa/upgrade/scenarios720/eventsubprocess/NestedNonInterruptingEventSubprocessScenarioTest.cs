...
//	import static org.camunda.bpm.qa.upgrade.util.ActivityInstanceAssert.describeActivityInstanceTree;
	...
	[ScenarioUnderTest("NestedNonInterruptingEventSubprocessScenario"), Origin("7.2.0")]
...
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.3") public void testInitActivityInstanceTree()
	  ...
	  public virtual void testInitActivityInstanceTree()
	  {
		...
		assertThat(activityInstance).hasStructure(describeActivityInstanceTree(instance.ProcessDefinitionId).beginScope("subProcess").activity("innerTask").activity("eventSubProcessTask").done());
	  }
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.innerTask.1") public void testInitTask1Completion()
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.innerTask.2") public void testInitTask1ActivityInstanceTree()
	  ...
	  public virtual void testInitTask1ActivityInstanceTree()
	  {
		...
		// then
		Assert.assertNotNull(activityInstance);
		assertThat(activityInstance).hasStructure(describeActivityInstanceTree(instance.ProcessDefinitionId).beginScope("subProcess").activity("eventSubProcessTask").done());
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.innerTask.3") public void testInitTask1Deletion()
	  [ScenarioUnderTest("init.innerTask.3")]
	  public virtual void testInitTask1Deletion()
	  {
		// given
		ProcessInstance instance = rule.processInstance();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.innerTask.4") public void testInitTask1ThrowError()
	  [ScenarioUnderTest("init.innerTask.4")]
	  public virtual void testInitTask1ThrowError()
	  {
		// given
		ProcessInstance instance = rule.processInstance();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.innerTask.5") public void testInitTask1ThrowUnhandledException()
	  [ScenarioUnderTest("init.innerTask.5")]
	  public virtual void testInitTask1ThrowUnhandledException()
	  {
		// given
		ProcessInstance instance = rule.processInstance();
		Task eventSubprocessTask = rule.taskQuery().singleResult();
