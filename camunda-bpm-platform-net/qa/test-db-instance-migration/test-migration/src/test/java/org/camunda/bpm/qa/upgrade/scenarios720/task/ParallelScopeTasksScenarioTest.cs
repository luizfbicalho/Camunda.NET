...
//	import static org.camunda.bpm.qa.upgrade.util.ActivityInstanceAssert.describeActivityInstanceTree;
	...
	/// 
	/// </summary>
	[ScenarioUnderTest("ParallelScopeTasksScenario"), Origin("7.2.0")]
...
//ORIGINAL LINE: @Test @ScenarioUnderTest("init.plain.1") public void testInitPlainActivityInstance()
	  ...
	  public virtual void testInitPlainActivityInstance()
	  {
		...
		assertThat(activityInstance).hasStructure(describeActivityInstanceTree(instance.ProcessDefinitionId).activity("task1").activity("task2").done());
	  }
