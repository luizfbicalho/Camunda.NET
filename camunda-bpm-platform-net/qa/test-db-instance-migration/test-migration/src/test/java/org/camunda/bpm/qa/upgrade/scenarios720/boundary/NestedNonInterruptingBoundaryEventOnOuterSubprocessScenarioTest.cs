...
//	import static org.camunda.bpm.qa.upgrade.util.ActivityInstanceAssert.describeActivityInstanceTree;
	...
	[ScenarioUnderTest("NestedNonInterruptingBoundaryEventOnOuterSubprocessScenario"), Origin("7.2.0")]
...
//ORIGINAL LINE: @Test @ScenarioUnderTest("initTimer.3") public void testInitTimerActivityInstanceTree()
	  ...
	  public virtual void testInitTimerActivityInstanceTree()
	  {
		...
		assertThat(activityInstance).hasStructure(describeActivityInstanceTree(instance.ProcessDefinitionId).activity("afterBoundaryTask").beginScope("outerSubProcess").beginScope("innerSubProcess").activity("innerSubProcessTask").done());
	  }
