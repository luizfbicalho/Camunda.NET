 ...
 */
namespace org.camunda.bpm.qa.upgrade.scenarios780
{
...
//	import static org.junit.Assert.assertTrue;
	...
	[ScenarioUnderTest("CreateProcessInstanceWithJsonVariablesScenario"), Origin("7.8.0")]
...
//ORIGINAL LINE: @ScenarioUnderTest("initProcessInstance.1") @Test public void testCreateProcessInstanceWithVariable()
	  ...
	  {
		// then
		ProcessInstance processInstance = engineRule.RuntimeService.createProcessInstanceQuery().processInstanceBusinessKey("processWithJsonVariables").singleResult();
