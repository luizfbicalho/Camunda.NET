...
namespace org.camunda.bpm.qa.upgrade
{
	...
	using CreateProcessInstanceWithVariableScenario = org.camunda.bpm.qa.upgrade.variable.CreateProcessInstanceWithVariableScenario;

	public class TestFixture
	{

	  public const string ENGINE_VERSION = "7.7.0";
	  ...
	  public static void Main(string[] args)
	  {
		...
		// compensation
		runner.setupScenarios(typeof(CreateProcessInstanceWithVariableScenario));
