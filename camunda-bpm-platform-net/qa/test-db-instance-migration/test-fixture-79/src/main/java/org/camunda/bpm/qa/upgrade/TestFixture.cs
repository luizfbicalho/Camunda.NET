...
namespace org.camunda.bpm.qa.upgrade
{
	...
	using CreateRootProcessInstanceWithoutRootIdScenario = org.camunda.bpm.qa.removaltime.CreateRootProcessInstanceWithoutRootIdScenario;
	using CreateProcessInstanceWithJsonVariablesScenario = org.camunda.bpm.qa.upgrade.json.CreateProcessInstanceWithJsonVariablesScenario;

	public class TestFixture
	{

	  public const string ENGINE_VERSION = "7.9.0";
