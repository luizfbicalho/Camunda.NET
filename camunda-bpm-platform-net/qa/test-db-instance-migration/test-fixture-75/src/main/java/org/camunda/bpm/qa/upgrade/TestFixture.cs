...
namespace org.camunda.bpm.qa.upgrade
{
	...
	using DeployProcessWithoutIsExecutableAttributeScenario = org.camunda.bpm.qa.upgrade.scenarios.deployment.DeployProcessWithoutIsExecutableAttributeScenario;
	/// <summary>
	...
	public class TestFixture
	{
	  ...
	  public const string ENGINE_VERSION = "7.5.0";
