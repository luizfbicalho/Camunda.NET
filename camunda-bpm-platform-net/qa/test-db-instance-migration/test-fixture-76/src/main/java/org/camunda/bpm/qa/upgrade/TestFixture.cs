...
namespace org.camunda.bpm.qa.upgrade
{
	...
	using DeployUserWithoutSaltForPasswordHashingScenario = org.camunda.bpm.qa.upgrade.user.creation.DeployUserWithoutSaltForPasswordHashingScenario;
	...
	public class TestFixture
	{
	  ...
	  public const string ENGINE_VERSION = "7.6.0";
	  ...
	  public static void Main(string[] args)
	  {
		...
		// compensation
		runner.setupScenarios(typeof(DeployUserWithoutSaltForPasswordHashingScenario));
