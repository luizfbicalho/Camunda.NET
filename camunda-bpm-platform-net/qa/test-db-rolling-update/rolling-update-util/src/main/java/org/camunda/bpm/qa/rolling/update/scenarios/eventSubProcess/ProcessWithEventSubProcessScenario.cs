 ...
 */
namespace org.camunda.bpm.qa.rolling.update.scenarios.eventSubProcess
{
	...
	public class ProcessWithEventSubProcessScenario
	{
	  ...
	  public const string PROCESS_DEF_KEY = "processWithEventSubProcess";
...
//ORIGINAL LINE: @Deployment public static String deploy()
	  ...
	  [DescribesScenario("init.error"), Times(1)]
