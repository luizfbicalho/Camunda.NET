...
namespace org.camunda.bpm.qa.rolling.update.scenarios.timestamp
{
	...
	/// </summary>
	public class JobTimestampsUpdateScenario : AbstractTimestampUpdateScenario
	{
	  ...
	  protected internal const string PROCESS_DEFINITION_KEY = "jobTimestampsUpdateTestProcess";
