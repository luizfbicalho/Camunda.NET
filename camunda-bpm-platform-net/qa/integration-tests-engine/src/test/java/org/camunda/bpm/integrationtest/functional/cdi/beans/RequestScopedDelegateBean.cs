...
namespace org.camunda.bpm.integrationtest.functional.cdi.beans
{
	...
	/// <summary>
	/// A <seealso cref="RequestScoped"/> bean
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Named @RequestScoped public class RequestScopedDelegateBean implements org.camunda.bpm.engine.delegate.JavaDelegate
	public class RequestScopedDelegateBean : JavaDelegate
	{
