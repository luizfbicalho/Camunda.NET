...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentResumePreviousOnDeploymentName extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentResumePreviousOnDeploymentName : AbstractFoxPlatformIntegrationTest
	{
	  ...
	  {
		return initWebArchiveDeployment("pa2.war", "org/camunda/bpm/integrationtest/deployment/war/resumePreviousVersionsOnDeploymentName_processes.xml").addAsResource("org/camunda/bpm/integrationtest/deployment/war/testProcess.bpmn20.xml");
