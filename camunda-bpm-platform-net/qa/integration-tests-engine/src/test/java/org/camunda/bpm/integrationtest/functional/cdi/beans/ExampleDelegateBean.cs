...
//ORIGINAL LINE: @Named public class ExampleDelegateBean implements org.camunda.bpm.engine.delegate.JavaDelegate
	public class ExampleDelegateBean : JavaDelegate
	{
	  ...
	  public virtual bool Invoked
	  {
		  ...
		  set
		  {
			ExampleDelegateBean.invoked = value;
		  }
	  }
