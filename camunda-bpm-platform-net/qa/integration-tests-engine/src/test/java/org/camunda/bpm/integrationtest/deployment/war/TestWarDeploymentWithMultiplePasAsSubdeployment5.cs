...
namespace org.camunda.bpm.integrationtest.deployment.war
{
	...
	/// <summary>
	/// <para>This test verifies that a WAR deployment can process multiple subdeployments that define process archives</para>
	/// 
	/// <pre>
	///   |-- My-Application.war
	///       |-- WEB-INF
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentWithMultiplePasAsSubdeployment5 extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentWithMultiplePasAsSubdeployment5 : AbstractFoxPlatformIntegrationTest
	{
...
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive processArchive()
	  public static WebArchive processArchive()
	  {
		...
		JavaArchive pa2 = ShrinkWrap.create(typeof(JavaArchive), "pa2.jar").addAsResource(processAssets[3], "process3.bpmn").addAsResource(processAssets[4], "directory/process4.bpmn").addAsResource(processAssets[5], "alternateDirectory/process5.bpmn");

		JavaArchive pa3 = ShrinkWrap.create(typeof(JavaArchive), "pa3.jar").addAsResource(processAssets[6], "process6.bpmn").addAsResource(processAssets[7], "directory/process7.bpmn").addAsResource(processAssets[8], "alternateDirectory/process8.bpmn");
