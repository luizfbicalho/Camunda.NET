...
//ORIGINAL LINE: @Named(value = "taskListener") public class ExampleTaskListener implements org.camunda.bpm.engine.delegate.TaskListener
	public class ExampleTaskListener : TaskListener
	{
