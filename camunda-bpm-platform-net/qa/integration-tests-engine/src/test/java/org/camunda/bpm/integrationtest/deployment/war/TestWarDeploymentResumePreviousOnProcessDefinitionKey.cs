...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentResumePreviousOnProcessDefinitionKey extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentResumePreviousOnProcessDefinitionKey : AbstractFoxPlatformIntegrationTest
	{
	  ...
	  {
		return initWebArchiveDeployment("pa2.war", "org/camunda/bpm/integrationtest/deployment/war/resumePreviousVersionsOnProcessDefinitionKey_processes.xml").addAsResource("org/camunda/bpm/integrationtest/deployment/war/testDeployProcessArchiveV2.bpmn20.xml");
