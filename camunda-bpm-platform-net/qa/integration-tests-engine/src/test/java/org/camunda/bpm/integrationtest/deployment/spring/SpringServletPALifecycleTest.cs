...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class SpringServletPALifecycleTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class SpringServletPALifecycleTest : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
