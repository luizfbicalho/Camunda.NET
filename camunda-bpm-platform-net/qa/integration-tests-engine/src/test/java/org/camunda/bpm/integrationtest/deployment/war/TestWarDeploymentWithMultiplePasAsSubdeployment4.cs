...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentWithMultiplePasAsSubdeployment4 extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentWithMultiplePasAsSubdeployment4 : AbstractFoxPlatformIntegrationTest
	{
...
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive processArchive()
	  public static WebArchive processArchive()
	  {
		...
		JavaArchive pa2 = ShrinkWrap.create(typeof(JavaArchive), "pa2.jar").addAsResource(processAssets[0], "process0.bpmn").addAsResource(processAssets[1], "directory/process1.bpmn");


		JavaArchive pa3 = ShrinkWrap.create(typeof(JavaArchive), "pa3.jar").addAsResource(processAssets[0], "process0.bpmn").addAsResource(processAssets[2], "alternateDirectory/process2.bpmn");

		WebArchive deployment = ShrinkWrap.create(typeof(WebArchive), "test.war").addAsResource(pa2ProcessesXml, "META-INF/processes.xml").addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml").addAsLibraries(DeploymentHelper.EngineCdi).addAsLibraries(pa2).addAsLibraries(pa3).addClass(typeof(AbstractFoxPlatformIntegrationTest));
