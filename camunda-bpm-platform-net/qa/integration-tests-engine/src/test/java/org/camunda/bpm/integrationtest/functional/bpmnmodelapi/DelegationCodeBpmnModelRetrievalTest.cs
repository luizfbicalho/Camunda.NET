...
namespace org.camunda.bpm.integrationtest.functional.bpmnmodelapi
{
	...
	using BpmnElementRetrievalDelegate = org.camunda.bpm.integrationtest.functional.bpmnmodelapi.beans.BpmnElementRetrievalDelegate;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class DelegationCodeBpmnModelRetrievalTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class DelegationCodeBpmnModelRetrievalTest : AbstractFoxPlatformIntegrationTest
	{
