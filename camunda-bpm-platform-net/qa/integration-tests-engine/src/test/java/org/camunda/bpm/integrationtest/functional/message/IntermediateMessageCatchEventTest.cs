 ...
 */
namespace org.camunda.bpm.integrationtest.functional.message
{
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class IntermediateMessageCatchEventTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class IntermediateMessageCatchEventTest : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive createProcessArchiveDeployment()
		...
		{
		return initWebArchiveDeployment().addAsResource("org/camunda/bpm/integrationtest/functional/message/IntermediateMessageCatchEventTest.bpmn20.xml");
		}
