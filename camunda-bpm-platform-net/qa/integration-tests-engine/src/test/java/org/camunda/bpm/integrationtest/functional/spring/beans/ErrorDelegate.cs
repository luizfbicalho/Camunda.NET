 ...
 */
namespace org.camunda.bpm.integrationtest.functional.spring.beans
{
...
//ORIGINAL LINE: @Component public class ErrorDelegate implements org.camunda.bpm.engine.delegate.JavaDelegate
	public class ErrorDelegate : JavaDelegate
	{
