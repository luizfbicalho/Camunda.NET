...
//	import static org.junit.Assert.assertEquals;
	...
	using VersionTagBean = org.camunda.bpm.integrationtest.functional.dmn.beans.VersionTagBean;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class BusinessRuleTaskVersionTagTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class BusinessRuleTaskVersionTagTest : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive createProcessArchiveDeployment()
		...
		{
		return initWebArchiveDeployment().addClass(typeof(VersionTagBean)).addAsResource("org/camunda/bpm/integrationtest/functional/dmn/BusinessRuleTaskVersionTagTest.testDecisionVersionTagOkay.dmn11.xml").addAsResource("org/camunda/bpm/integrationtest/functional/dmn/BusinessRuleTaskVersionTagTest.bpmn20.xml");
		}
...
//ORIGINAL LINE: @Test @OperateOnDeployment("clientDeployment") public void testStartInstanceWithBeanCondition()
	  public virtual void testStartInstanceWithBeanCondition()
	  {
		...
		assertEquals("okay", runtimeService.getVariable(processInstance.Id, "result"));
	  }
	}
