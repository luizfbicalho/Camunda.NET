...
//ORIGINAL LINE: @Named public class RemoteSLSBClientDelegateBean implements org.camunda.bpm.engine.delegate.JavaDelegate
	public class RemoteSLSBClientDelegateBean : JavaDelegate
	{
...
//ORIGINAL LINE: @Override public void execute(org.camunda.bpm.engine.delegate.DelegateExecution execution) throws Exception
		...
		{
		BusinessInterface businessInterface = (BusinessInterface) (new InitialContext()).lookup("java:global/" + TestConstants.AppName + "service/" + "RemoteSLSBean!org.camunda.bpm.integrationtest.functional.ejb.remote.bean.BusinessInterface");
