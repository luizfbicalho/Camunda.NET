...
namespace org.camunda.bpm.integrationtest.functional.classloading.war
{
	...
	using ExampleCaseVariableListener = org.camunda.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class CaseVariableListenerResolutionTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class CaseVariableListenerResolutionTest : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive createProcessArchiveDeplyoment()
		...
		{
		return initWebArchiveDeployment().addClass(typeof(ExampleCaseVariableListener)).addAsResource("org/camunda/bpm/integrationtest/functional/classloading/CaseVariableListenerResolutionTest.cmmn");
		}
