...
namespace org.camunda.bpm.integrationtest.service
{
	...
	/// <summary>
	/// <para>Makes sure that the process engine JNDI bindings are created</para>
	/// 
	/// @author Daniel Meyer
	/// 
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestProcessEngineJndiBinding_JBOSS extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestProcessEngineJndiBinding_JBOSS : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
