...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentIsDeployChangedOnly extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentIsDeployChangedOnly : AbstractFoxPlatformIntegrationTest
	{
	  ...
	  {
		return initWebArchiveDeployment("pa2.war", "org/camunda/bpm/integrationtest/deployment/war/isDeployChangedOnly_processes.xml").addAsResource("org/camunda/bpm/integrationtest/deployment/war/testDeployProcessArchiveV1.bpmn20.xml").addAsResource("org/camunda/bpm/integrationtest/deployment/war/testProcess.bpmn20.xml");
