...
//	import static org.junit.Assert.assertNotNull;
	...
	public class PaLocalScriptEngineSupportTest : AbstractPaLocalScriptEngineTest
	{
...
//ORIGINAL LINE: @Test public void shouldSetVariable()
	  ...
	  {
		string processInstanceId = runtimeService.startProcessInstanceByKey(PROCESS_ID).Id;
