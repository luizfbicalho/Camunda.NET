...
//ORIGINAL LINE: @Named public class ConditionalFlowBean
...
//ORIGINAL LINE: @Inject protected org.camunda.bpm.engine.RuntimeService runtimeService;
	  protected internal RuntimeService runtimeService;
		...
		public virtual bool shouldTakeFlow()
		{
		  object takeFlow = runtimeService.getVariable(processInstance.Id, "takeFlow");

		  return true.Equals(takeFlow);
		}
	}
