...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestMultipleProcessEnginesXmlsInLibrary extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestMultipleProcessEnginesXmlsInLibrary : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
