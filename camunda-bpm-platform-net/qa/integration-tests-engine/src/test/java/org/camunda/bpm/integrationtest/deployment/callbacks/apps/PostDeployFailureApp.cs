...
//ORIGINAL LINE: @ProcessApplication public class PostDeployFailureApp extends org.camunda.bpm.application.impl.ServletProcessApplication
	public class PostDeployFailureApp : ServletProcessApplication
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PostDeploy public void fail()
