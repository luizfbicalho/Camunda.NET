...
namespace org.camunda.bpm.integrationtest.functional.ejb
{
	...
	using SingletonBeanClientDelegate = org.camunda.bpm.integrationtest.functional.ejb.beans.SingletonBeanClientDelegate;
	using SingletonBeanDelegate = org.camunda.bpm.integrationtest.functional.ejb.beans.SingletonBeanDelegate;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class SingletonBeanDelegateTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class SingletonBeanDelegateTest : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive processArchive()
		public static WebArchive processArchive()
		{
		return initWebArchiveDeployment().addClass(typeof(SingletonBeanDelegate)).addClass(typeof(SingletonBeanClientDelegate)).addAsResource("org/camunda/bpm/integrationtest/functional/ejb/SingletonBeanDelegateTest.testBeanResolution.bpmn20.xml").addAsResource("org/camunda/bpm/integrationtest/functional/ejb/SingletonBeanDelegateTest.testBeanResolutionFromClient.bpmn20.xml");
		}
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		Assert.assertEquals(true, runtimeService.getVariable(pi.Id, typeof(SingletonBeanDelegate).FullName));

//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		runtimeService.setVariable(pi.Id, typeof(SingletonBeanDelegate).FullName, false);
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		  Assert.assertEquals("Incovation=" + i, true, runtimeService.getVariable(ids[i], typeof(SingletonBeanDelegate).FullName));
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		  runtimeService.setVariable(ids[i], typeof(SingletonBeanDelegate).FullName, false);
