...
namespace org.camunda.bpm.integrationtest.functional.ejb.local
{
	...
	using LocalSingletonBean = org.camunda.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBean;
	using LocalSingletonBeanClientDelegateBean = org.camunda.bpm.integrationtest.functional.ejb.local.bean.LocalSingletonBeanClientDelegateBean;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class LocalSingletonBeanInvocationTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class LocalSingletonBeanInvocationTest : AbstractFoxPlatformIntegrationTest
	{
		[Deployment(name:"pa", order:2)]
		public static WebArchive processArchive()
		{
		return initWebArchiveDeployment().addClass(typeof(LocalSingletonBeanClientDelegateBean)).addAsResource("org/camunda/bpm/integrationtest/functional/ejb/local/LocalSingletonBeanInvocationTest.testInvokeBean.bpmn20.xml").addAsWebInfResource("org/camunda/bpm/integrationtest/functional/ejb/local/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
		}
