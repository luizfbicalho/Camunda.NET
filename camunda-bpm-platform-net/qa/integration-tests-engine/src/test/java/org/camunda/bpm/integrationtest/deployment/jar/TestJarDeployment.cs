 ...
 */
namespace org.camunda.bpm.integrationtest.deployment.jar
{
	...
	using OverProtocol = org.jboss.arquillian.container.test.api.OverProtocol;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestJarDeployment extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestJarDeployment : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
