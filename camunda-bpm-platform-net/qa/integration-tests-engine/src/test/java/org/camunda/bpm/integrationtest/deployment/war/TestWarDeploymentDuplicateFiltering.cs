...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentDuplicateFiltering extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentDuplicateFiltering : AbstractFoxPlatformIntegrationTest
	{
	  ...
	  {
		return initWebArchiveDeployment("pa2.war").addAsResource("org/camunda/bpm/integrationtest/testDeployProcessArchive.bpmn20.xml");
	  }

	  [Deployment(order:2, name:PA2)]
	  public static WebArchive processArchive2()
	  {
		return initWebArchiveDeployment("pa1.war").addAsResource("org/camunda/bpm/integrationtest/testDeployProcessArchive.bpmn20.xml");
