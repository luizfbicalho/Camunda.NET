...
//ORIGINAL LINE: @ProcessApplication public class CustomServletProcessApplication extends org.camunda.bpm.application.impl.ServletProcessApplication
	public class CustomServletProcessApplication : ServletProcessApplication
	{
