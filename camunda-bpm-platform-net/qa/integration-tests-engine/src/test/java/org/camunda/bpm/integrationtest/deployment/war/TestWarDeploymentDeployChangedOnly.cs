...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentDeployChangedOnly extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentDeployChangedOnly : AbstractFoxPlatformIntegrationTest
	{
	  ...
	  {
		return initWebArchiveDeployment("pa2.war", "org/camunda/bpm/integrationtest/deployment/war/deployChangedOnly_processes.xml").addAsResource("org/camunda/bpm/integrationtest/deployment/war/testDeployProcessArchiveV2.bpmn20.xml").addAsResource("org/camunda/bpm/integrationtest/deployment/war/testDeployProcessArchiveUnchanged.bpmn20.xml");
