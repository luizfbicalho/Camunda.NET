...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentWithoutProcessDefinitions extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentWithoutProcessDefinitions : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
