...
//ORIGINAL LINE: @Named public class RemoteSFSBClientDelegateBean implements org.camunda.bpm.engine.delegate.JavaDelegate
	public class RemoteSFSBClientDelegateBean : JavaDelegate
	{
...
//ORIGINAL LINE: @Override public void execute(org.camunda.bpm.engine.delegate.DelegateExecution execution) throws Exception
		...
		{
		BusinessInterface businessInterface = (BusinessInterface) (new InitialContext()).lookup("java:global/" + TestConstants.AppName + "service/" + "RemoteSFSBean!org.camunda.bpm.integrationtest.functional.ejb.remote.bean.BusinessInterface");
