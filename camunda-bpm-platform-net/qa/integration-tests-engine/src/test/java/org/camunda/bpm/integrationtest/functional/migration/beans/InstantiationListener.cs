 ...
 */
namespace org.camunda.bpm.integrationtest.functional.migration.beans
{
	...
	/// 
	/// </summary>
	public class InstantiationListener : ExecutionListener
	{

	  public const string VARIABLE_NAME = "startListenerCalled";
