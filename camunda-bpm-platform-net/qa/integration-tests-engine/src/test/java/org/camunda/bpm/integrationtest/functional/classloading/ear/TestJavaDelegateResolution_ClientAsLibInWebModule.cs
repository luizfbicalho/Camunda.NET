 ...
 */
namespace org.camunda.bpm.integrationtest.functional.classloading.ear
{
	...
	/// <summary>
	/// <para>Deploys an EAR application which contains a WAR process archive, and a client application deployed as a war</para>
	/// 
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestJavaDelegateResolution_ClientAsLibInWebModule extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestJavaDelegateResolution_ClientAsLibInWebModule : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @OperateOnDeployment("clientDeployment") public void testResolveClassFromJobExecutor() throws InterruptedException, javax.transaction.SystemException
