...
//	import static org.junit.Assert.assertNotNull;
	...
	public class PaDataformatAndPostDeployApp : ServletProcessApplication
	{

	  public const string PA_NAME = "PaDataformatAndPostDeployApp";

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @PostDeploy public void onPaDeployed(org.camunda.bpm.engine.ProcessEngine e) throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void onPaDeployed(ProcessEngine e)
	  {

		assertNotNull(VariableSerializers);
