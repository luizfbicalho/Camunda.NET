...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class TestWarDeploymentWithDiagram extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class TestWarDeploymentWithDiagram : AbstractFoxPlatformIntegrationTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Deployment public static org.jboss.shrinkwrap.api.spec.WebArchive processArchive()
		public static WebArchive processArchive()
		{
		return initWebArchiveDeployment().addClass(typeof(TestHelper)).addAsResource("org/camunda/bpm/integrationtest/testDeployProcessArchive.bpmn20.xml").addAsResource("org/camunda/bpm/integrationtest/testDeployProcessArchive.png").addAsResource("org/camunda/bpm/integrationtest/invoice-it.bpmn20.xml").addAsResource("org/camunda/bpm/integrationtest/invoice-it.jpg");
		}
