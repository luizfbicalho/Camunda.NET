...
namespace org.camunda.bpm.integrationtest.functional.ejb.request
{
	...
	using InvocationCounterDelegateBeanLocal = org.camunda.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBeanLocal;
...
//ORIGINAL LINE: @RunWith(Arquillian.class) public class JobExecutorRequestContextLocalInvocationTest extends org.camunda.bpm.integrationtest.util.AbstractFoxPlatformIntegrationTest
	public class JobExecutorRequestContextLocalInvocationTest : AbstractFoxPlatformIntegrationTest
	{
		[Deployment(name:"pa", order:2)]
		public static WebArchive processArchive()
		{
		return initWebArchiveDeployment().addClass(typeof(RequestScopedDelegateBean)).addClass(typeof(RequestScopedSFSBDelegate)).addClass(typeof(InvocationCounterDelegateBean)).addClass(typeof(InvocationCounterDelegateBeanLocal)).addAsResource("org/camunda/bpm/integrationtest/functional/ejb/request/JobExecutorRequestContextLocalInvocationTest.testContextPropagationEjbLocal.bpmn20.xml").addAsWebInfResource("org/camunda/bpm/integrationtest/functional/ejb/request/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
		}
