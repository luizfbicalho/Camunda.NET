...
//ORIGINAL LINE: @ProcessApplication public class TestProcessApplication extends org.camunda.bpm.application.impl.ServletProcessApplication
	public class TestProcessApplication : ServletProcessApplication
	{
