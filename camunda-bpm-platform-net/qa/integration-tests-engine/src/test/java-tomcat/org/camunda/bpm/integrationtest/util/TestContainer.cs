...
namespace org.camunda.bpm.integrationtest.util
{
	...
	public class TestContainer
	{
	  ...
	  {
		webArchive.addAsManifestResource("context.xml").addAsLibraries(DeploymentHelper.Weld).addClass(typeof(TestProcessApplication)).addAsWebInfResource("web.xml");
	  }

	  public static void addContainerSpecificResourcesWithoutWeld(WebArchive webArchive)
	  {
		webArchive.addAsManifestResource("context.xml").addClass(typeof(TestProcessApplication)).addAsWebInfResource("web-without-weld.xml", "web.xml");
	  }

	  public static void addContainerSpecificResourcesForNonPa(WebArchive webArchive)
	  {
		webArchive.addAsManifestResource("context.xml").addAsLibraries(DeploymentHelper.Weld).addAsWebInfResource("web.xml");
	  }

	  public static void addContainerSpecificResourcesForNonPaWithoutWeld(WebArchive webArchive)
	  {
		webArchive.addAsManifestResource("context.xml").addAsWebInfResource("web-without-weld.xml", "web.xml");
	  }
