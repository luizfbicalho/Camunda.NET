...
namespace org.camunda.bpm.qa.performance.engine.steps
{
	...
	/// 
	/// </summary>
	public class StartProcessInstanceByMessageStep : ProcessEngineAwareStep
	{

	  protected internal string message;
	  protected internal IDictionary<string, object> processVariables;

	  public StartProcessInstanceByMessageStep(ProcessEngine processEngine, string message) : this(processEngine, message, null)
	  {
	  }

	  public StartProcessInstanceByMessageStep(ProcessEngine processEngine, string message, IDictionary<string, object> processVariables) : base(processEngine)
	  {
