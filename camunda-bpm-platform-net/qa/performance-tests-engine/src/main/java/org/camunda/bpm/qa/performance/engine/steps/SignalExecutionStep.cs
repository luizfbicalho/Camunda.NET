...
namespace org.camunda.bpm.qa.performance.engine.steps
{
	...
	/// 
	/// </summary>
	public class SignalExecutionStep : ProcessEngineAwareStep
	{

	  protected internal string executionIdVariableName;

	  public SignalExecutionStep(ProcessEngine processEngine, string executionIdVariableName) : base(processEngine)
	  {
