...
namespace org.camunda.bpm.qa.performance.engine.loadgenerator.tasks
{
	...
	/// 
	/// </summary>
	public class DeployModelInstancesTask : ThreadStart
	{

	  protected internal readonly IList<BpmnModelInstance> modelInstances;
	  protected internal readonly ProcessEngine engine;

	  public DeployModelInstancesTask(ProcessEngine engine, IList<BpmnModelInstance> modelInstances)
	  {
		this.engine = engine;
