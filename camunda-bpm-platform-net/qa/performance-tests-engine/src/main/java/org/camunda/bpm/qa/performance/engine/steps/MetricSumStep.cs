...
namespace org.camunda.bpm.qa.performance.engine.steps
{
	...
	/// </summary>
	public class MetricSumStep : ProcessEngineAwareStep
	{
	  ...
	  public MetricSumStep(string name, DateTime startDate, DateTime endDate, ProcessEngine processEngine) : base(processEngine)
	  {
		this.name = name;
