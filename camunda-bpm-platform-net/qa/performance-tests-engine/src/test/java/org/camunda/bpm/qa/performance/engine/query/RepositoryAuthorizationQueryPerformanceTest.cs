...
//ORIGINAL LINE: @SuppressWarnings("rawtypes") @RunWith(Parameterized.class) public class RepositoryAuthorizationQueryPerformanceTest extends org.camunda.bpm.qa.performance.engine.junit.AuthorizationPerformanceTestCase
	public class RepositoryAuthorizationQueryPerformanceTest : AuthorizationPerformanceTestCase
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Parameter(4) public static org.camunda.bpm.engine.impl.identity.Authentication authentication;
	  ...
	  static RepositoryAuthorizationQueryPerformanceTest()
	  {
		...
		{
			"DeploymentQuery", repositoryService.createDeploymentQuery(), DEPLOYMENT, new Permission[] {READ}
		},
		new object[]
		{
			"ProcessDefinitionQuery", repositoryService.createProcessDefinitionQuery(), DEPLOYMENT, new Permission[] {READ}
		});
...
//ORIGINAL LINE: @Test public void queryList()
	  ...
	  {
		  private readonly RepositoryAuthorizationQueryPerformanceTest outerInstance;

		  public PerfTestStepBehaviorAnonymousInnerClass(RepositoryAuthorizationQueryPerformanceTest outerInstance)
		  {
...
//ORIGINAL LINE: @Test public void queryCount()
	  ...
	  private class PerfTestStepBehaviorAnonymousInnerClass2 : PerfTestStepBehavior
	  {
		  ...
		  public PerfTestStepBehaviorAnonymousInnerClass2(RepositoryAuthorizationQueryPerformanceTest outerInstance)
		  {
			  this.outerInstance = outerInstance;
		  }
