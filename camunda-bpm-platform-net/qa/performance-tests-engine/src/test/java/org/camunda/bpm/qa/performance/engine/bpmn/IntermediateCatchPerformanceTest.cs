...
namespace org.camunda.bpm.qa.performance.engine.bpmn
{
	...
	/// 
	/// </summary>
	public class IntermediateCatchPerformanceTest : ProcessEnginePerformanceTestCase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Deployment public void singleMessage()
	  public virtual void singleMessage()
	  {
