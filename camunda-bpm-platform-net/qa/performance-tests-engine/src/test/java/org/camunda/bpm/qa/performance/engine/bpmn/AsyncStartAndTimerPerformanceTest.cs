...
namespace org.camunda.bpm.qa.performance.engine.bpmn
{
	...
	public class AsyncStartAndTimerPerformanceTest : ProcessEngineJobExecutorPerformanceTestCase
	{
...
//ORIGINAL LINE: @Test @Deployment public void test()
	  ...
	  {
		performanceTest().step(new StartProcessInstanceStep(engine, "process")).step(new WaitStep()).run();
	  }
