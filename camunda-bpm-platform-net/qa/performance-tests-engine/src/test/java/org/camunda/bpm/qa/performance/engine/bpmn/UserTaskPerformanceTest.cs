...
//	import static org.camunda.bpm.qa.performance.engine.steps.PerfTestConstants.TASK_ID;
	...
	using CompleteTaskStep = org.camunda.bpm.qa.performance.engine.steps.CompleteTaskStep;
	...
	/// 
	/// </summary>
	public class UserTaskPerformanceTest : ProcessEnginePerformanceTestCase
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Deployment public void singleTask()
	  public virtual void singleTask()
	  {
		performanceTest().step(new StartProcessInstanceStep(engine, "process")).step(new CompleteTaskStep(engine, TASK_ID)).run();
	  }
