...
//ORIGINAL LINE: @SuppressWarnings("rawtypes") @RunWith(Parameterized.class) public class HistoryAuthorizationQueryPerformanceTest extends org.camunda.bpm.qa.performance.engine.junit.AuthorizationPerformanceTestCase
	public class HistoryAuthorizationQueryPerformanceTest : AuthorizationPerformanceTestCase
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Parameter(4) public static org.camunda.bpm.engine.impl.identity.Authentication authentication;
	  ...
	  static HistoryAuthorizationQueryPerformanceTest()
	  {
		...
		{
			"HistoricProcessInstanceQuery", historyService.createHistoricProcessInstanceQuery(), PROCESS_DEFINITION, new Permission[] {READ_HISTORY}
		},
		new object[]
		{
			"HistoricActivityInstanceQuery", historyService.createHistoricActivityInstanceQuery(), PROCESS_DEFINITION, new Permission[] {READ_HISTORY}
		});
...
//ORIGINAL LINE: @Test public void queryList()
	  ...
	  {
		  private readonly HistoryAuthorizationQueryPerformanceTest outerInstance;

		  public PerfTestStepBehaviorAnonymousInnerClass(HistoryAuthorizationQueryPerformanceTest outerInstance)
		  {
...
//ORIGINAL LINE: @Test public void queryCount()
	  ...
	  private class PerfTestStepBehaviorAnonymousInnerClass2 : PerfTestStepBehavior
	  {
		  ...
		  public PerfTestStepBehaviorAnonymousInnerClass2(HistoryAuthorizationQueryPerformanceTest outerInstance)
		  {
			  this.outerInstance = outerInstance;
		  }
