...
//	import static org.junit.Assert.fail;
	...
	using SubsystemAttributeDefinitons = org.camunda.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons;
	...
	public class JBossSubsystemXMLTest : AbstractSubsystemTest
	{
	  ...
	  public const string SUBSYSTEM_WITH_ALL_OPTIONS = "subsystemWithAllOptions.xml";
	  public const string SUBSYSTEM_WITH_REQUIRED_OPTIONS = "subsystemWithRequiredOptions.xml";
	  public const string SUBSYSTEM_WITH_NO_OPTIONS = "subsystemWithNoOptions.xml";
	  public const string SUBSYSTEM_WITH_ALL_OPTIONS_WITH_EXPRESSIONS = "subsystemWithAllOptionsWithExpressions.xml";
	  ...
	  public static readonly ServiceName PLATFORM_BPM_PLATFORM_PLUGINS_SERVICE_NAME = ServiceNames.forBpmPlatformPlugins();
	  public static readonly ServiceName PLATFORM_JOBEXECUTOR_MANAGED_THREAD_POOL_SERVICE_NAME = ServiceNames.forManagedThreadPool(SubsystemAttributeDefinitons.THREAD_POOL_NAME.DefaultValue.asString());

	  public static readonly ServiceName PROCESS_ENGINE_SERVICE_BINDING_SERVICE_NAME = ContextNames.GLOBAL_CONTEXT_SERVICE_NAME.append("camunda-bpm-platform").append("process-engine").append("ProcessEngineService!org.camunda.bpm.ProcessEngineService");

	  public JBossSubsystemXMLTest() : base(org.camunda.bpm.container.impl.jboss.extension.ModelConstants_Fields.SUBSYSTEM_NAME, new BpmPlatformExtension(), SubsystemRemoveOrderComparator)
	  {
	  }
	  ...
	  static JBossSubsystemXMLTest()
	  {
		...
		EXPRESSION_PROPERTIES["org.camunda.bpm.jboss.job-executor.core-threads"] = "5";
		EXPRESSION_PROPERTIES["org.camunda.bpm.jboss.job-executor.max-threads"] = "15";
		EXPRESSION_PROPERTIES["org.camunda.bpm.jboss.job-executor.queue-length"] = "15";
		EXPRESSION_PROPERTIES["org.camunda.bpm.jboss.job-executor.keepalive-time"] = "10";
		EXPRESSION_PROPERTIES["org.camunda.bpm.jboss.job-executor.allow-core-timeout"] = "false";
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testInstallSubsystemXmlPlatformPlugins()
	  {
		...
		ServiceContainer container = services.Container;
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: org.jboss.msc.service.ServiceController<?> serviceController = container.getService(PLATFORM_BPM_PLATFORM_PLUGINS_SERVICE_NAME);
		ServiceController<object> serviceController = container.getService(PLATFORM_BPM_PLATFORM_PLUGINS_SERVICE_NAME);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testInstallSubsystemWithDuplicateEngineNamesXml()
	  {
		...
		{
		  assertTrue("Duplicate process engine detected!", fpe.NestedException.Message.contains("A process engine with name '__test' already exists."));
		}
	  }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	...
	//    System.out.println(operations);
		...
		assertFalse(jobAcquisition.has(Element.PROPERTIES.LocalName));
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: org.jboss.msc.service.ServiceController<?> managedQueueExecutorServiceController = container.getService(org.camunda.bpm.container.impl.jboss.service.ServiceNames.forManagedThreadPool(org.camunda.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons.DEFAULT_JOB_EXECUTOR_THREADPOOL_NAME));
		ServiceController<object> managedQueueExecutorServiceController = container.getService(ServiceNames.forManagedThreadPool(SubsystemAttributeDefinitons.DEFAULT_JOB_EXECUTOR_THREADPOOL_NAME));
		assertNotNull(managedQueueExecutorServiceController);
		object managedQueueExecutorServiceObject = managedQueueExecutorServiceController.Value;
		assertNotNull(managedQueueExecutorServiceObject);
		assertTrue(managedQueueExecutorServiceObject is ManagedQueueExecutorService);
		ManagedQueueExecutorService managedQueueExecutorService = (ManagedQueueExecutorService) managedQueueExecutorServiceObject;
		assertEquals("Number of core threads is wrong", SubsystemAttributeDefinitons.DEFAULT_CORE_THREADS, managedQueueExecutorService.CoreThreads);
		assertEquals("Number of max threads is wrong", SubsystemAttributeDefinitons.DEFAULT_MAX_THREADS, managedQueueExecutorService.MaxThreads);
		assertEquals(SubsystemAttributeDefinitons.DEFAULT_KEEPALIVE_TIME, TimeUnit.NANOSECONDS.toSeconds(managedQueueExecutorService.KeepAlive));
		assertEquals(false, managedQueueExecutorService.Blocking);
		assertEquals(SubsystemAttributeDefinitons.DEFAULT_ALLOW_CORE_TIMEOUT, managedQueueExecutorService.AllowCoreTimeout);

//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: org.jboss.msc.service.ServiceController<?> threadFactoryService = container.getService(org.camunda.bpm.container.impl.jboss.service.ServiceNames.forThreadFactoryService(org.camunda.bpm.container.impl.jboss.extension.SubsystemAttributeDefinitons.DEFAULT_JOB_EXECUTOR_THREADPOOL_NAME));
		ServiceController<object> threadFactoryService = container.getService(ServiceNames.forThreadFactoryService(SubsystemAttributeDefinitons.DEFAULT_JOB_EXECUTOR_THREADPOOL_NAME));
		assertNotNull(threadFactoryService);
		assertTrue(threadFactoryService.Value is ThreadFactory);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testParseAndMarshalModelWithAllAvailableOptions() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testParseAndMarshalModelWithAllAvailableOptions()
	  {
		parseAndMarshalSubsystemModelFromFile(SUBSYSTEM_WITH_ALL_OPTIONS);
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testParseAndMarshalModelWithRequiredOptionsOnly() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testParseAndMarshalModelWithRequiredOptionsOnly()
	  {
		parseAndMarshalSubsystemModelFromFile(SUBSYSTEM_WITH_REQUIRED_OPTIONS);
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testParseAndMarshalModelWithAllAvailableOptionsWithExpressions() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testParseAndMarshalModelWithAllAvailableOptionsWithExpressions()
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testParseSubsystemXmlWithAllOptionsWithExpressions() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testParseSubsystemXmlWithAllOptionsWithExpressions()
	  {
		...
		assertExpressionType(operations[2], "thread-pool-name", "core-threads", "max-threads", "queue-length", "keepalive-time", "allow-core-timeout");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testInstallSubsystemXmlWithAllOptionsWithExpressions() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
	  public virtual void testInstallSubsystemXmlWithAllOptionsWithExpressions()
	  {
		System.Properties.putAll(EXPRESSION_PROPERTIES);
		try
		{
...
//ORIGINAL LINE: org.jboss.msc.service.ServiceController<?> defaultEngineService = container.getService(org.camunda.bpm.container.impl.jboss.service.ServiceNames.forManagedProcessEngine("__test"));
	  ...
	  ///  Compares the models afterwards. </summary>
	  /// <param name="subsystemXmlFile"> the name of the subsystem xml file </param>
	  /// <exception cref="Exception"> </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void parseAndMarshalSubsystemModelFromFile(String subsystemXmlFile) throws Exception
	  protected internal virtual void parseAndMarshalSubsystemModelFromFile(string subsystemXmlFile)
	  {
		...
		string marshalled = servicesA.PersistedSubsystemXml;
	  ...
	  protected internal virtual void commonSubsystemServicesAreInstalled(ServiceContainer container)
	  {
		assertNotNull("platform service should be installed", container.getService(PLATFORM_SERVICE_NAME));
		assertNotNull("process engine service should be bound in JNDI", container.getService(PROCESS_ENGINE_SERVICE_BINDING_SERVICE_NAME));
	  ...
	  protected internal static IComparer<PathAddress> SubsystemRemoveOrderComparator
	  {
		  get
		  {
	//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
	//ORIGINAL LINE: final java.util.List<org.jboss.as.controller.PathAddress> REMOVE_ORDER_OF_SUBSYSTEM = java.util.Arrays.asList(org.jboss.as.controller.PathAddress.pathAddress(org.camunda.bpm.container.impl.jboss.extension.BpmPlatformExtension.SUBSYSTEM_PATH), org.jboss.as.controller.PathAddress.pathAddress(org.camunda.bpm.container.impl.jboss.extension.BpmPlatformExtension.JOB_EXECUTOR_PATH), org.jboss.as.controller.PathAddress.pathAddress(org.camunda.bpm.container.impl.jboss.extension.BpmPlatformExtension.JOB_ACQUISTIONS_PATH), org.jboss.as.controller.PathAddress.pathAddress(org.camunda.bpm.container.impl.jboss.extension.BpmPlatformExtension.PROCESS_ENGINES_PATH));
			IList<PathAddress> REMOVE_ORDER_OF_SUBSYSTEM = Arrays.asList(PathAddress.pathAddress(BpmPlatformExtension.SUBSYSTEM_PATH), PathAddress.pathAddress(BpmPlatformExtension.JOB_EXECUTOR_PATH), PathAddress.pathAddress(BpmPlatformExtension.JOB_ACQUISTIONS_PATH), PathAddress.pathAddress(BpmPlatformExtension.PROCESS_ENGINES_PATH));
    
			return new ComparatorAnonymousInnerClass(REMOVE_ORDER_OF_SUBSYSTEM);
		  }
	  }

	  private class ComparatorAnonymousInnerClass : IComparer<PathAddress>
	  {
		  private IList<PathAddress> REMOVE_ORDER_OF_SUBSYSTEM;

		  public ComparatorAnonymousInnerClass(IList<PathAddress> REMOVE_ORDER_OF_SUBSYSTEM)
		  {
			  this.REMOVE_ORDER_OF_SUBSYSTEM = REMOVE_ORDER_OF_SUBSYSTEM;
		  }

		  protected internal PathAddress normalizePathAddress(PathAddress pathAddress)
		  {
			if (pathAddress.size() == 1 && pathAddress.Equals(REMOVE_ORDER_OF_SUBSYSTEM[0]))
			{
			  return pathAddress;
			}
			else
		  ...
		  protected internal int getOrder(PathAddress pathAddress)
		  {
			foreach (PathAddress orderedAddress in REMOVE_ORDER_OF_SUBSYSTEM)
			{
			  if (orderedAddress.LastElement.Key.Equals(pathAddress.LastElement.Key))
			  {
				return REMOVE_ORDER_OF_SUBSYSTEM.IndexOf(orderedAddress);
			  }
			}
			throw new System.ArgumentException("Unable to find a match for path address: " + pathAddress);
		  }
