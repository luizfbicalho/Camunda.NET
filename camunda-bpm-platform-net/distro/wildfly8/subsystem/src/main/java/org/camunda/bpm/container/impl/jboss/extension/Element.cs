...
namespace org.camunda.bpm.container.impl.jboss.extension
{
	...
	public sealed class Element
	{
	  ...
	  public static readonly Element SUBSYSTEM = new Element("SUBSYSTEM", InnerEnum.SUBSYSTEM, "subsystem");
	  ...
	  public static readonly Element CORE_THREADS = new Element("CORE_THREADS", InnerEnum.CORE_THREADS, ModelConstants_Fields.CORE_THREADS);
	  public static readonly Element MAX_THREADS = new Element("MAX_THREADS", InnerEnum.MAX_THREADS, ModelConstants_Fields.MAX_THREADS);
	  public static readonly Element QUEUE_LENGTH = new Element("QUEUE_LENGTH", InnerEnum.QUEUE_LENGTH, ModelConstants_Fields.QUEUE_LENGTH);
	  public static readonly Element KEEPALIVE_TIME = new Element("KEEPALIVE_TIME", InnerEnum.KEEPALIVE_TIME, ModelConstants_Fields.KEEPALIVE_TIME);
	  public static readonly Element ALLOW_CORE_TIMEOUT = new Element("ALLOW_CORE_TIMEOUT", InnerEnum.ALLOW_CORE_TIMEOUT, ModelConstants_Fields.ALLOW_CORE_TIMEOUT);
...
//ORIGINAL LINE: final String name = element.getLocalName();
		...
		MAP = map;
		  ...
		  valueList.Add(SUBSYSTEM);
		  valueList.Add(JOB_EXECUTOR);
		  valueList.Add(THREAD_POOL_NAME);
		  valueList.Add(CORE_THREADS);
		  valueList.Add(MAX_THREADS);
		  valueList.Add(QUEUE_LENGTH);
		  valueList.Add(KEEPALIVE_TIME);
		  valueList.Add(ALLOW_CORE_TIMEOUT);
