...
namespace org.camunda.bpm.container.impl.jboss.test
{
	...
	/// </summary>
	public class BpmPlatformSubsystemEnginesAndJobExecutorTest : AbstractSubsystemBaseTest
	{

	  public BpmPlatformSubsystemEnginesAndJobExecutorTest() : base(org.camunda.bpm.container.impl.jboss.extension.ModelConstants_Fields.SUBSYSTEM_NAME, new BpmPlatformExtension())
	  {
	  }
