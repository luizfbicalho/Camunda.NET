...
namespace org.camunda.bpm.container.impl.jboss.test
{
	...
	/// </summary>
	public class BpmPlatformSubsystemTest : AbstractSubsystemBaseTest
	{

	  public BpmPlatformSubsystemTest() : base(org.camunda.bpm.container.impl.jboss.extension.ModelConstants_Fields.SUBSYSTEM_NAME, new BpmPlatformExtension())
	  {
	  }
...
//ORIGINAL LINE: @Override protected String getSubsystemXml() throws java.io.IOException
	  ...
	  /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected String getSubsystemXsdPath() throws Exception
	  protected internal virtual string SubsystemXsdPath
	  {
		  get
		  {
