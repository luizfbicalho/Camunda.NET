...
namespace org.camunda.bpm.container.impl.jboss.extension
{
	...
	public sealed class Attribute
	{
	  ...
	  public static readonly Attribute NAME = new Attribute("NAME", InnerEnum.NAME, SubsystemAttributeDefinitons.NAME);
	  public static readonly Attribute DEFAULT = new Attribute("DEFAULT", InnerEnum.DEFAULT, SubsystemAttributeDefinitons.DEFAULT);
