...
namespace org.camunda.bpm.container.impl.jboss.extension
{
	...
	public static class ModelConstants_Fields
	{
	  ...
	  public const string MAX_THREADS = "max-threads";
	  public const string CORE_THREADS = "core-threads";
	  public const string QUEUE_LENGTH = "queue-length";
	  public const string ALLOW_CORE_TIMEOUT = "allow-core-timeout";
	  public const string KEEPALIVE_TIME = "keepalive-time";
