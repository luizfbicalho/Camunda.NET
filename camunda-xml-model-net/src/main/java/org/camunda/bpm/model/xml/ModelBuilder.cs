...
{
	using ModelBuilderImpl = org.camunda.bpm.model.xml.impl.ModelBuilderImpl;
	...
	public abstract class ModelBuilder
	{
	  ...
	  public abstract ModelElementTypeBuilder defineType(Type modelInstanceType, string typeName);
