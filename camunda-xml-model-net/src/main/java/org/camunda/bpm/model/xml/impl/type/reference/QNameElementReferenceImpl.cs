...
namespace org.camunda.bpm.model.xml.impl.type.reference
{
	...
	/// </summary>
	public class QNameElementReferenceImpl<Target, Source> : ElementReferenceImpl<Target, Source> where Target : org.camunda.bpm.model.xml.instance.ModelElementInstance where Source : org.camunda.bpm.model.xml.instance.ModelElementInstance
	{

	  public QNameElementReferenceImpl(ChildElement<Source> referenceSourceCollection) : base(referenceSourceCollection)
	  {
	  }
