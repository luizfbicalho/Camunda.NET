...
namespace org.camunda.bpm.model.xml.impl.type.reference
{
	...
	public class UriElementReferenceCollectionImpl<Target, Source> : ElementReferenceCollectionImpl<Target, Source> where Target : org.camunda.bpm.model.xml.instance.ModelElementInstance where Source : org.camunda.bpm.model.xml.instance.ModelElementInstance
	{

	  public UriElementReferenceCollectionImpl(ChildElementCollection<Source> referenceSourceCollection) : base(referenceSourceCollection)
	  {
	  }
