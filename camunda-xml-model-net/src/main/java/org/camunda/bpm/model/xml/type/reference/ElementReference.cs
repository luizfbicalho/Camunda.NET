...
namespace org.camunda.bpm.model.xml.type.reference
{
	...
	/// </summary>
	public interface ElementReference<Target, Source> : ElementReferenceCollection<Target, Source> where Target : org.camunda.bpm.model.xml.instance.ModelElementInstance where Source : org.camunda.bpm.model.xml.instance.ModelElementInstance
	{
