...
namespace org.camunda.bpm.model.xml.impl.type.attribute
{
	...
	/// </summary>
	public class IntegerAttribute : AttributeImpl<int>
	{
	  ...
	  protected internal override int? convertXmlValueToModelValue(string rawValue)
	  {
		try
		{
	  ...
	  protected internal virtual string convertModelValueToXmlValue(int? modelValue)
	  {
