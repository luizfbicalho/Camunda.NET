...
namespace org.camunda.bpm.model.xml.test.assertions
{
	...
	/// </summary>
	public class ModelAssertions : Assertions
	{

	  public static AttributeAssert assertThat<T1>(Attribute<T1> actual)
	  {
	  ...
	  public static AttributeReferenceAssert assertThat<T1>(AttributeReference<T1> actual)
	  {
		return new AttributeReferenceAssert(actual);
	  }

	  public static ElementReferenceCollectionAssert assertThat<T1>(ElementReferenceCollection<T1> actual)
	  {
