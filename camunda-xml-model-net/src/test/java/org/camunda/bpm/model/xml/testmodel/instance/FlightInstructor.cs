...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
	...
	/// </summary>
	public class FlightInstructor : ModelElementInstanceImpl
	{

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(FlightInstructor), ELEMENT_NAME_FLIGHT_INSTRUCTOR).namespaceUri(MODEL_NAMESPACE).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());

		typeBuilder.build();
	  }

	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelTypeInstanceProvider<FlightInstructor>
	  {
	  ...
	  public FlightInstructor(ModelTypeInstanceContext instanceContext) : base(instanceContext)
	  {
	  }
