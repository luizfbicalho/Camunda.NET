...
//ORIGINAL LINE: @Test public void testStringListSplit()
	  public virtual void testStringListSplit()
	  {
		assertThat(splitCommaSeparatedList("")).Empty;
		assertThat(splitCommaSeparatedList("  ")).Empty;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testStringListJoin()
	  public virtual void testStringListJoin()
	  {
		assertThat(joinCommaSeparatedList(null)).Null;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testNullSplit()
	  public virtual void testNullSplit()
	  {
		assertThat(splitCommaSeparatedList(null)).Empty;
	  }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void testNullJoin()
	  public virtual void testNullJoin()
	  {
		assertThat(joinCommaSeparatedList(null)).Null;
	  }
