...
//	import static org.camunda.bpm.model.xml.type.ModelElementTypeBuilder.ModelTypeInstanceProvider;
	...
	/// </summary>
	public class SignalImpl : BaseElementImpl, Signal
	{
	  ...
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(Signal), BPMN_ELEMENT_SIGNAL).namespaceUri(BPMN20_NS).extendsType(typeof(RootElement)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());
	  ...
	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelTypeInstanceProvider<Signal>
	  {
