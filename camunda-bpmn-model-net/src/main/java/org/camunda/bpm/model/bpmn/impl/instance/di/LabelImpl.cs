...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DI_NS;
	...
	/// </summary>
	public abstract class LabelImpl : NodeImpl, Label
	{
	  ...
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(Label), DI_ELEMENT_LABEL).namespaceUri(DI_NS).extendsType(typeof(Node)).abstractType();

		SequenceBuilder sequenceBuilder = typeBuilder.sequence();

		boundsChild = sequenceBuilder.element(typeof(Bounds)).build();
