...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_TRANSACTION;
	...
	/// 
	/// </summary>
	public class TransactionImpl : SubProcessImpl, Transaction
	{

	  protected internal static Attribute<TransactionMethod> methodAttribute;
	  ...
	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelElementTypeBuilder.ModelTypeInstanceProvider<Transaction>
	  {
