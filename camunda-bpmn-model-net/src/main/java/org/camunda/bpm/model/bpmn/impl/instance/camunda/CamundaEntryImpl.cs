...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;
	...
	/// </summary>
	public class CamundaEntryImpl : CamundaGenericValueElementImpl, CamundaEntry
	{

	  protected internal static Attribute<string> camundaKeyAttribute;
	  ...
	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelElementTypeBuilder.ModelTypeInstanceProvider<CamundaEntry>
	  {
	  ...
	  public virtual string CamundaKey
	  {
		  ...
		  set
		  {
			camundaKeyAttribute.setValue(this, value);
		  }
	  }
