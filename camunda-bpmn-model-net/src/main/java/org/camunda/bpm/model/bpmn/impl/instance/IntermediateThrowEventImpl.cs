...
{
	using IntermediateThrowEventBuilder = org.camunda.bpm.model.bpmn.builder.IntermediateThrowEventBuilder;
...
//	import static org.camunda.bpm.model.xml.type.ModelElementTypeBuilder.ModelTypeInstanceProvider;
	...
	public class IntermediateThrowEventImpl : ThrowEventImpl, IntermediateThrowEvent
	{
	  ...
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(IntermediateThrowEvent), BPMN_ELEMENT_INTERMEDIATE_THROW_EVENT).namespaceUri(BpmnModelConstants.BPMN20_NS).extendsType(typeof(ThrowEvent)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());

		typeBuilder.build();
	  }

	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelTypeInstanceProvider<IntermediateThrowEvent>
	  {
	  ...
	  public override IntermediateThrowEventBuilder builder()
	  {
