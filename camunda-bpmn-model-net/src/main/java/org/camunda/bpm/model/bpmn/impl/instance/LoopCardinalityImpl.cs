...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_LOOP_CARDINALITY;
	...
	/// </summary>
	public class LoopCardinalityImpl : ExpressionImpl, LoopCardinality
	{

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(LoopCardinality), BPMN_ELEMENT_LOOP_CARDINALITY).namespaceUri(BPMN20_NS).extendsType(typeof(Expression)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());

		typeBuilder.build();
	  }

	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelElementTypeBuilder.ModelTypeInstanceProvider<LoopCardinality>
	  {
