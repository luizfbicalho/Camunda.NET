...
namespace org.camunda.bpm.model.bpmn.builder
{
	...
	public class ErrorEventDefinitionBuilder : AbstractErrorEventDefinitionBuilder<ErrorEventDefinitionBuilder>
	{
	  ...
	  public ErrorEventDefinitionBuilder(BpmnModelInstance modelInstance, ErrorEventDefinition element) : base(modelInstance, element, typeof(ErrorEventDefinitionBuilder))
	  {
	  }
	}
