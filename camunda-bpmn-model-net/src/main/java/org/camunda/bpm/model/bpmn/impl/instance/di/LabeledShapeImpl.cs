...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DI_NS;
	...
	/// </summary>
	public abstract class LabeledShapeImpl : ShapeImpl, LabeledShape
	{
		public override abstract org.camunda.bpm.model.bpmn.instance.Extension Extension {set;}

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(LabeledShape), DI_ELEMENT_LABELED_SHAPE).namespaceUri(DI_NS).extendsType(typeof(Shape)).abstractType();
