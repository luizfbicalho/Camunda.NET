...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_ROOT_ELEMENT;
	...
	/// </summary>
	public abstract class RootElementImpl : BaseElementImpl, RootElement
	{

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(RootElement), BPMN_ELEMENT_ROOT_ELEMENT).namespaceUri(BPMN20_NS).extendsType(typeof(BaseElement)).abstractType();
