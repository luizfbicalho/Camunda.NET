...
//	import static org.camunda.bpm.model.xml.type.ModelElementTypeBuilder.ModelTypeInstanceProvider;
	...
	/// </summary>
	public class ServiceTaskImpl : TaskImpl, ServiceTask
	{
	  ...
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(ServiceTask), BPMN_ELEMENT_SERVICE_TASK).namespaceUri(BPMN20_NS).extendsType(typeof(Task)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());
	  ...
	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelTypeInstanceProvider<ServiceTask>
	  {
	  ...
	  public override ServiceTaskBuilder builder()
	  {
