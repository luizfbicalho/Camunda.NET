...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_PERFORMER;
	...
	/// </summary>
	public class PerformerImpl : ResourceRoleImpl, Performer
	{

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(Performer), BPMN_ELEMENT_PERFORMER).namespaceUri(BPMN20_NS).extendsType(typeof(ResourceRole)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());
		typeBuilder.build();
	  }

	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelElementTypeBuilder.ModelTypeInstanceProvider<Performer>
	  {
