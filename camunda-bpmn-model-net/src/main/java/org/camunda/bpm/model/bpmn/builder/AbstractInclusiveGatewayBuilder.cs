...
namespace org.camunda.bpm.model.bpmn.builder
{
	...
	/// </summary>
	public abstract class AbstractInclusiveGatewayBuilder<B> : AbstractGatewayBuilder<B, InclusiveGateway> where B : AbstractInclusiveGatewayBuilder<B>
	{

	  protected internal AbstractInclusiveGatewayBuilder(BpmnModelInstance modelInstance, InclusiveGateway element, Type selfType) : base(modelInstance, element, selfType)
	  {
	  }
