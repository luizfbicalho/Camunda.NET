...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public interface Activity : FlowNode, InteractionNode
	{
	  ...
	  ICollection<DataInputAssociation> DataInputAssociations {get;}

	  ICollection<DataOutputAssociation> DataOutputAssociations {get;}

	  ICollection<ResourceRole> ResourceRoles {get;}

	  LoopCharacteristics LoopCharacteristics {get;set;}
