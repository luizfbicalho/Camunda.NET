...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_COMPLEX_BEHAVIOR_DEFINITION;
	...
	/// </summary>
	public class ComplexBehaviorDefinitionImpl : BaseElementImpl, ComplexBehaviorDefinition
	{

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(ComplexBehaviorDefinition), BPMN_ELEMENT_COMPLEX_BEHAVIOR_DEFINITION).namespaceUri(BPMN20_NS).extendsType(typeof(BaseElement)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());

		typeBuilder.build();
	  }

	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelElementTypeBuilder.ModelTypeInstanceProvider<ComplexBehaviorDefinition>
	  {
