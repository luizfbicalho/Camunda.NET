...
//	import static org.camunda.bpm.model.xml.type.ModelElementTypeBuilder.ModelTypeInstanceProvider;
	...
	public class MessagePath : FormalExpressionImpl
	{
	  ...
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(MessagePath), BPMN_ELEMENT_MESSAGE_PATH).namespaceUri(BPMN20_NS).extendsType(typeof(FormalExpression)).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());

		typeBuilder.build();
	  }

	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelTypeInstanceProvider<MessagePath>
	  {
