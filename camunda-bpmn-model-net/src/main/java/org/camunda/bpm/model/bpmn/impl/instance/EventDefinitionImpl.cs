...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_EVENT_DEFINITION;
	...
	/// </summary>
	public abstract class EventDefinitionImpl : RootElementImpl, EventDefinition
	{

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(EventDefinition), BPMN_ELEMENT_EVENT_DEFINITION).namespaceUri(BPMN20_NS).extendsType(typeof(RootElement)).abstractType();
