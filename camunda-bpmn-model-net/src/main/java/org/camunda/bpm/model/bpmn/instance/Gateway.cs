...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public interface Gateway : FlowNode
	{

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("rawtypes") org.camunda.bpm.model.bpmn.builder.AbstractGatewayBuilder builder();
	  AbstractGatewayBuilder builder();

	  GatewayDirection GatewayDirection {get;set;}


	  BpmnShape DiagramElement {get;}
