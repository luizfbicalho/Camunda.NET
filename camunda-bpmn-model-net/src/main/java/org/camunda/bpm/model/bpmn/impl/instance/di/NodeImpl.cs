...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DI_NS;
	...
	/// </summary>
	public abstract class NodeImpl : DiagramElementImpl, Node
	{
		public override abstract org.camunda.bpm.model.bpmn.instance.Extension Extension {set;}

	  public static void registerType(ModelBuilder modelBuilder)
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(Node), DI_ELEMENT_NODE).namespaceUri(DI_NS).extendsType(typeof(DiagramElement)).abstractType();
