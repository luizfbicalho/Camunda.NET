...
//	import static org.camunda.bpm.model.xml.type.ModelElementTypeBuilder.ModelTypeInstanceProvider;
	...
	/// </summary>
	public class CamundaExecutionListenerImpl : BpmnModelElementInstanceImpl, CamundaExecutionListener
	{
	  ...
	  {
		ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(typeof(CamundaExecutionListener), CAMUNDA_ELEMENT_EXECUTION_LISTENER).namespaceUri(CAMUNDA_NS).instanceProvider(new ModelTypeInstanceProviderAnonymousInnerClass());
	  ...
	  private class ModelTypeInstanceProviderAnonymousInnerClass : ModelTypeInstanceProvider<CamundaExecutionListener>
	  {
	  ...
	  public CamundaExecutionListenerImpl(ModelTypeInstanceContext instanceContext) : base(instanceContext)
	  {
	  }
