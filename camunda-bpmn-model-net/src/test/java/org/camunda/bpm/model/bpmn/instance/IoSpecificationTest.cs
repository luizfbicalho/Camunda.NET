...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class IoSpecificationTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(DataInput)), new ChildElementAssumption(typeof(DataOutput)), new ChildElementAssumption(typeof(InputSet), 1), new ChildElementAssumption(typeof(OutputSet), 1)
		   );
		  }
	  }
