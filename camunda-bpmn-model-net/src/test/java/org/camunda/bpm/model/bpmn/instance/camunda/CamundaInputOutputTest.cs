...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;
	...
	/// </summary>
	public class CamundaInputOutputTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(CAMUNDA_NS, typeof(CamundaInputParameter)), new ChildElementAssumption(CAMUNDA_NS, typeof(CamundaOutputParameter))
		   );
		  }
	  }
