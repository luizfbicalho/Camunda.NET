...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class CorrelationSubscriptionTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(CorrelationPropertyBinding))
		   );
		  }
	  }
