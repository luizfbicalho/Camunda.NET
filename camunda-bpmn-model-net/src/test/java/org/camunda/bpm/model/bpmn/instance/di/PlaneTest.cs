...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DI_NS;
	...
	/// </summary>
	public class PlaneTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(DI_NS, typeof(Node), true);
		  }
	  }
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(DI_NS, typeof(DiagramElement))
		   );
		  }
	  }
