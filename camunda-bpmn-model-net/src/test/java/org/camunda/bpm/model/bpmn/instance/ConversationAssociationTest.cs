...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class ConversationAssociationTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("innerConversationNodeRef", false, true), new AttributeAssumption("outerConversationNodeRef", false, true)
		   );
		  }
	  }
	}
