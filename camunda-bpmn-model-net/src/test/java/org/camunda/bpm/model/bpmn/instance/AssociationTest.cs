...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class AssociationTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("sourceRef", false, true), new AttributeAssumption("targetRef", false, true), new AttributeAssumption("associationDirection", false, false, AssociationDirection.None)
		   );
		  }
	  }
	}
