...
{
	using CorrelationPropertyRef = org.camunda.bpm.model.bpmn.impl.instance.CorrelationPropertyRef;


	/// <summary>
	/// @author Sebastian Menski
	/// </summary>
	public class CorrelationKeyTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(CorrelationPropertyRef))
		   );
		  }
	  }
