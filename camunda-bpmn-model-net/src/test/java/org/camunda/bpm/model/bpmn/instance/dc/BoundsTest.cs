...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DC_NS;
	...
	/// </summary>
	public class BoundsTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("x", false, true), new AttributeAssumption("y", false, true), new AttributeAssumption("width", false, true), new AttributeAssumption("height", false, true)
		   );
		  }
	  }
	}
