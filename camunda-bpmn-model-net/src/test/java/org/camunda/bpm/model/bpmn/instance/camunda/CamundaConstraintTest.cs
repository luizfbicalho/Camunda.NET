...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;
	...
	/// </summary>
	public class CamundaConstraintTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption(CAMUNDA_NS, "name"), new AttributeAssumption(CAMUNDA_NS, "config")
		   );
		  }
	  }
	}
