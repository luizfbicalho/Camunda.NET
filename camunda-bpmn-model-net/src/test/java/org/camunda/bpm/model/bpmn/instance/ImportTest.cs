...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class ImportTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("namespace", false, true), new AttributeAssumption("location", false, true), new AttributeAssumption("importType", false, true)
		   );
		  }
	  }
	}
