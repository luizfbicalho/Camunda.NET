...
{
	using ResourceRef = org.camunda.bpm.model.bpmn.impl.instance.ResourceRef;


	/// <summary>
	/// @author Sebastian Menski
	/// </summary>
	public class ResourceRoleTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(ResourceRef), 0, 1), new ChildElementAssumption(typeof(ResourceParameterBinding)), new ChildElementAssumption(typeof(ResourceAssignmentExpression), 0, 1)
		   );
		  }
	  }
