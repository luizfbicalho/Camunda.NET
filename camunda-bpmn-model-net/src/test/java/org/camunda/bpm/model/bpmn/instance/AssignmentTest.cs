...
{
	using From = org.camunda.bpm.model.bpmn.impl.instance.From;
	using To = org.camunda.bpm.model.bpmn.impl.instance.To;


	/// <summary>
	/// @author Sebastian Menski
	/// </summary>
	public class AssignmentTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(From), 1, 1), new ChildElementAssumption(typeof(To), 1, 1)
		   );
		  }
	  }
