...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class ExtensionTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(Documentation))
		   );
		  }
	  }
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("definition"), new AttributeAssumption("mustUnderstand", false, false, false)
		   );
		  }
	  }
	}
