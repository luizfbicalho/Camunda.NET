...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class DocumentationTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("id", true), new AttributeAssumption("textFormat", false, false, "text/plain")
		   );
		  }
	  }
	}
