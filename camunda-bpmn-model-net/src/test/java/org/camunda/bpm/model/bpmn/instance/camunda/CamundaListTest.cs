...
//	import static org.junit.Assert.fail;
	...
	public class CamundaListTest : BpmnModelElementInstanceTest
	{
...
//ORIGINAL LINE: @Ignore("Test ignored. CAM-9441: Bug fix needed") @Test public void testListValueChildAssignment()
	  public virtual void testListValueChildAssignment()
	  {
		try
		{
		  CamundaList listElement = modelInstance.newInstance(typeof(CamundaList));

		  CamundaValue valueElement = modelInstance.newInstance(typeof(CamundaValue));
		...
		{
		  fail("CamundaValue should be accepted as a child element of CamundaList. Error: " + e.Message);
		}
	  }
	}
