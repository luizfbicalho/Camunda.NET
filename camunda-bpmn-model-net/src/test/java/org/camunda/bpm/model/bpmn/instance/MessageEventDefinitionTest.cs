...
{
	using OperationRef = org.camunda.bpm.model.bpmn.impl.instance.OperationRef;
...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;
	...
	/// </summary>
	public class MessageEventDefinitionTest : AbstractEventDefinitionTest
	{
	  ...
	  public override ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(OperationRef), 0, 1)
		   );
		  }
	  }
