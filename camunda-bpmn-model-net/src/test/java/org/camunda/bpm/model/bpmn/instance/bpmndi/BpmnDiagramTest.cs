...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.BPMNDI_NS;
	...
	/// </summary>
	public class BpmnDiagramTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(BPMNDI_NS, typeof(Diagram), false);
		  }
	  }
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(BPMNDI_NS, typeof(BpmnPlane), 1, 1), new ChildElementAssumption(BPMNDI_NS, typeof(BpmnLabelStyle))
		   );
		  }
	  }
