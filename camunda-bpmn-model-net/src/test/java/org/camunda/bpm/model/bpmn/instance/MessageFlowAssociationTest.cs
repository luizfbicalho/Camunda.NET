...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class MessageFlowAssociationTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("innerMessageFlowRef", false, true), new AttributeAssumption("outerMessageFlowRef", false, true)
		   );
		  }
	  }
	}
