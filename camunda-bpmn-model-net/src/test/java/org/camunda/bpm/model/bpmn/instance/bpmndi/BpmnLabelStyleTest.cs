...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DC_NS;
	...
	/// </summary>
	public class BpmnLabelStyleTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(BPMNDI_NS, typeof(Style), false);
		  }
	  }
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(DC_NS, typeof(Font), 1, 1)
		   );
		  }
	  }
