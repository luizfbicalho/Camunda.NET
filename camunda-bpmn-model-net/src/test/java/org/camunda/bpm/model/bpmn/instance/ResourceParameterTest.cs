...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class ResourceParameterTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("name"), new AttributeAssumption("type"), new AttributeAssumption("isRequired")
		   );
		  }
	  }
	}
