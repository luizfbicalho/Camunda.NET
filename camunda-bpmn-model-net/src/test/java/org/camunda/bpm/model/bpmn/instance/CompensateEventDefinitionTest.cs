...
//	import static org.assertj.core.api.Assertions.assertThat;
	...
	public class CompensateEventDefinitionTest : AbstractEventDefinitionTest
	{
	  ...
	  public override ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("waitForCompletion"), new AttributeAssumption("activityRef")
		   );
		  }
	  }
