...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class FormalExpressionTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(typeof(Expression), false);
		  }
	  }
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("language"), new AttributeAssumption("evaluatesToTypeRef")
		   );
		  }
	  }
	}
