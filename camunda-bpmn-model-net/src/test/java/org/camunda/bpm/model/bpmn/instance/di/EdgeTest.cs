...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.DI_NS;
	...
	/// </summary>
	public class EdgeTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(DI_NS, typeof(DiagramElement), true);
		  }
	  }
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(DI_NS, typeof(Waypoint), 2)
		   );
		  }
	  }
