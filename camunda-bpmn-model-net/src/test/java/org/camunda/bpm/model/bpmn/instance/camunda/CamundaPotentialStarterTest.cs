...
namespace org.camunda.bpm.model.bpmn.instance.camunda
{
	...
	/// </summary>
	public class CamundaPotentialStarterTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(ResourceAssignmentExpression), 0, 1)
		   );
		  }
	  }
