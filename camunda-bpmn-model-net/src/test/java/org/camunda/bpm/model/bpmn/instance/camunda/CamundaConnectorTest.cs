...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;
	...
	public class CamundaConnectorTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(CAMUNDA_NS, typeof(CamundaConnectorId), 1, 1), new ChildElementAssumption(CAMUNDA_NS, typeof(CamundaInputOutput), 0, 1)
		   );
		  }
	  }
