...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class ParticipantMultiplicityTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("minimum", false, false, 0), new AttributeAssumption("maximum", false, false, 1)
		   );
		  }
	  }
	}
