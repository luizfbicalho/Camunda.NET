...
//	import static org.assertj.core.api.Assertions.assertThat;
	...
	public class ErrorEventDefinitionTest : AbstractEventDefinitionTest
	{
	  ...
	  public override ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("errorRef"), new AttributeAssumption(CAMUNDA_NS, "errorCodeVariable"), new AttributeAssumption(CAMUNDA_NS, "errorMessageVariable")
		   );
		  }
	  }
