...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.XSI_NS;
	...
	/// </summary>
	public class ConditionExpressionTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(typeof(FormalExpression), false);
		  }
	  }
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption(XSI_NS, "type", false, false, "tFormalExpression"), new AttributeAssumption(CAMUNDA_NS, "resource")
		   );
		  }
	  }
	}
