...
//	import static org.camunda.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_NS;
	...
	public class CamundaScriptTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("scriptFormat", false, true), new AttributeAssumption("resource")
		   );
		  }
	  }
