...
{
	using CategoryValueRef = org.camunda.bpm.model.bpmn.impl.instance.CategoryValueRef;


	/// <summary>
	/// @author Sebastian Menski
	/// </summary>
	public class FlowElementTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<ChildElementAssumption> ChildElementAssumptions
	  {
		  get
		  {
			return Arrays.asList(new ChildElementAssumption(typeof(Auditing), 0, 1), new ChildElementAssumption(typeof(Monitoring), 0, 1), new ChildElementAssumption(typeof(CategoryValueRef))
		   );
		  }
	  }
