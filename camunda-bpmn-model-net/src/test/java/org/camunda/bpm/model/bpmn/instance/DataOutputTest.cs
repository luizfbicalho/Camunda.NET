...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class DataOutputTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual TypeAssumption TypeAssumption
	  {
		  get
		  {
			return new TypeAssumption(typeof(ItemAwareElement), false);
		  }
	  }
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("name"), new AttributeAssumption("isCollection", false, false, false)
		   );
		  }
	  }
	}
