...
namespace org.camunda.bpm.model.bpmn.instance
{
	...
	/// </summary>
	public class GatewayTest : BpmnModelElementInstanceTest
	{
	  ...
	  public virtual ICollection<AttributeAssumption> AttributesAssumptions
	  {
		  get
		  {
			return Arrays.asList(new AttributeAssumption("gatewayDirection", false, false, GatewayDirection.Unspecified)
		   );
		  }
	  }
	}
